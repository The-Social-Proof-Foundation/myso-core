...
//! This analysis flags situations when instances of a myso::table::Table or myso::table_vec::TableVec
//! or myso::bag::Bag are being compared for (in)equality at this type of comparison is not very
