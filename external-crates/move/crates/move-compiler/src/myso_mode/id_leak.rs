...
use crate::{
    ...
    myso_mode::{
        ...
        REGISTRY_CREATE_FUNCTION_NAME, MYSO_ADDR_NAME, MYSO_ADDR_VALUE, MYSO_CLOCK_CREATE,
        MYSO_SYSTEM_ADDR_VALUE, MYSO_SYSTEM_CREATE, MYSO_SYSTEM_MODULE_NAME,
...
pub const FRESH_ID_FUNCTIONS: &[(AccountAddress, Symbol, Symbol)] = &[
    ...
    (MYSO_ADDR_VALUE, OBJECT_MODULE_NAME, OBJECT_NEW_UID_FROM_HASH),
    (
        MYSO_ADDR_VALUE,
