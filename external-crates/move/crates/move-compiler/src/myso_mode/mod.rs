...
pub const MYSO_ADDR_NAME: Symbol = symbol!("myso");
...
pub const MYSO_MODULE_NAME: Symbol = symbol!("myso");
pub const MYSO_OTW_NAME: Symbol = symbol!("MYSO");

pub const MYSO_SYSTEM_ADDR_NAME: Symbol = symbol!("myso_system");
pub const MYSO_SYSTEM_MODULE_NAME: Symbol = symbol!("myso_system");
pub const MYSO_SYSTEM_CREATE: Symbol = symbol!("create");
pub const CLOCK_MODULE_NAME: Symbol = symbol!("clock");
pub const CLOCK_TYPE_NAME: Symbol = symbol!("Clock");
pub const MYSO_CLOCK_CREATE: Symbol = symbol!("create");
...
pub const MYSO_DIAG_PREFIX: &str = "MySo ";
