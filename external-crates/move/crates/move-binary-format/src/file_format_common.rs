...
const _: () = {
    ...
    assert!(BinaryFlavor::mask_and_shift_to_unflavor(x) == BinaryFlavor::MYSO_FLAVOR);
};
...
impl BinaryFlavor {
    ...
    // The MySo flavor is 0x05
    pub const MYSO_FLAVOR: u8 = 0x05;
    ...
    const fn shift_and_flavor(unflavored: u32) -> u32 {
        ((Self::MYSO_FLAVOR as u32) << Self::SHIFT_AMOUNT) | unflavored
    }
}
