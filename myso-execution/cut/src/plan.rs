...
mod tests {
    ...
    fn test_workspace_read() {
        ...
        let myso_execution = root.join("myso-execution");
        ...
        // Other examples
        assert!(ws.members.contains(&myso_execution));
    ...
    fn test_no_workspace() {
        ...
        expect!["No [workspace] found at $PATH/myso-execution/cut/Cargo.toml/Cargo.toml"]
    ...
    fn test_cut_plan_discover() {
        ...
        let plan = CutPlan::discover(Args {
            ...
            packages: vec![
                ...
                "myso-adapter-latest".to_string(),
                "myso-execution-cut".to_string(),
                "myso-verifier-latest".to_string(),
            ],
        })
        .unwrap();
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/myso-execution/cut-cut",
                    "$PATH/myso-execution/cut-move-core-types",
                    "$PATH/myso-execution/exec-cut",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/myso-execution/cut-move-core-types",
                        ws_state: Exclude,
                    },
                    "myso-adapter-latest": CutPackage {
                        dst_name: "myso-adapter-feature",
                        src_path: "$PATH/myso-execution/latest/myso-adapter",
                        dst_path: "$PATH/myso-execution/exec-cut/myso-adapter",
                        ws_state: Member,
                    },
                    "myso-execution-cut": CutPackage {
                        dst_name: "myso-execution-cut-feature",
                        src_path: "$PATH/myso-execution/cut",
                        dst_path: "$PATH/myso-execution/cut-cut",
                        ws_state: Member,
                    },
                    "myso-verifier-latest": CutPackage {
                        dst_name: "myso-verifier-feature",
                        src_path: "$PATH/myso-execution/latest/myso-verifier",
                        dst_path: "$PATH/myso-execution/exec-cut/myso-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
        ...
        expect![[r#"
            ...
            new [workspace] members:
             - to:   myso-adapter-feature
                     myso-execution/exec-cut/myso-adapter
               from: myso-adapter-latest
                     myso-execution/latest/myso-adapter
             - to:   myso-execution-cut-feature
                     myso-execution/cut-cut
               from: myso-execution-cut
                     myso-execution/cut
             - to:   myso-verifier-feature
                     myso-execution/exec-cut/myso-verifier
               from: myso-verifier-latest
                     myso-execution/latest/myso-verifier

            new [workspace] excludes:
             - to:   move-core-types-feature
                     myso-execution/cut-move-core-types
    ...
    fn test_cut_plan_discover_new_top_level_destination() {
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/myso-execution/feature",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/myso-execution/feature/move/crates/move-core-types",
                        ws_state: Exclude,
                    },
                    "myso-adapter-latest": CutPackage {
                        dst_name: "myso-adapter-feature",
                        src_path: "$PATH/myso-execution/latest/myso-adapter",
                        dst_path: "$PATH/myso-execution/feature/myso-adapter",
                        ws_state: Member,
                    },
                    "myso-execution-cut": CutPackage {
                        dst_name: "myso-execution-cut-feature",
                        src_path: "$PATH/myso-execution/cut",
                        dst_path: "$PATH/myso-execution/feature/cut",
                        ws_state: Member,
                    },
                    "myso-verifier-latest": CutPackage {
                        dst_name: "myso-verifier-feature",
                        src_path: "$PATH/myso-execution/latest/myso-verifier",
                        dst_path: "$PATH/myso-execution/feature/myso-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
