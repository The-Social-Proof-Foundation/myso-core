...
struct MySoVerifierMeterBounds {
    name: String,
    ticks: u128,
    max_ticks: Option<u128>,
}

impl MySoVerifierMeterBounds {
...
pub struct MySoVerifierMeter {
    transaction_bounds: MySoVerifierMeterBounds,
    package_bounds: MySoVerifierMeterBounds,
    module_bounds: MySoVerifierMeterBounds,
    function_bounds: MySoVerifierMeterBounds,
}

impl MySoVerifierMeter {
    ...
    fn get_bounds_mut(&mut self, scope: Scope) -> &mut MySoVerifierMeterBounds {
        match scope {
    ...
    fn get_bounds(&self, scope: Scope) -> &MySoVerifierMeterBounds {
        match scope {
...
impl Meter for MySoVerifierMeter {
