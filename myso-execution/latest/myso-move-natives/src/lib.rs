...
pub fn all_natives(silent: bool, protocol_config: &ProtocolConfig) -> NativeFunctionTable {
    let myso_framework_natives: &[(&str, &str, NativeFunction)] = &[
        (
            "accumulator",
            "emit_deposit_event",
        ...
        (
            ...
            "record_settlement_myso_conservation",
            make_native!(accumulator::record_settlement_myso_conservation),
        ),
    ...
    let myso_framework_natives_iter =
        myso_framework_natives
            .iter()
            .cloned()
    ...
    let myso_system_natives: &[(&str, &str, NativeFunction)] = &[(
        "validator",
    ...
    myso_system_natives
        ...
        .chain(myso_framework_natives_iter)
        ...
        _ => {
            return Err(
                PartialVMError::new(StatusCode::UNKNOWN_INVARIANT_VIOLATION_ERROR)
                    .with_message("MySo verifier guarantees this is a struct".to_string()),
            );
        }
    };
