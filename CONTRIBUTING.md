...
Thanks for considering making a contribution to the MySo network or its documentation. Before you get started, please take a moment to read these guidelines.
...
If you want to contribute code that creates a feature on MySo, start with a [MySo Improvement Proposal](https://github.com/myso-foundation/sips/tree/main) before developing the logic.
