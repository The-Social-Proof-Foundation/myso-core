        ...
        >
          <div className="w-full mt-8 mb-4 mx-auto">
            <div className={styles.heroText}>
              <h1 className="h1 center-text text-white">MySo Documentation</h1>
              <h2 className="h2 center-text h3" style={{ color: '#89919F' }}>
                Discover the power of MySo through examples, guides, and concepts
              </h2>
            </div>
          </div>
          <div className="flex flex-row flex-wrap justify-center gap-2 max-w-[1066px] mx-auto pb-16 py-4">
            <HomeCard title="Developers">
              <Link
                ...
                to="./guides/developer/getting-started/myso-install"
              >
                Getting Started
              </Link>
              <Link className={styles.cardLink} to="/guides">
                MySo Developer Basics
              </Link>
              <Link
                className={styles.cardLink}
                to="./concepts/myso-move-concepts"
              >
                Move
              </Link>
            </HomeCard>
            <HomeCard title="Validators and Node operators">
              ...
              <Link
                className={styles.cardLink}
                to="./guides/operator/myso-full-node"
              >
                Run a MySo Full Node
              ...
              >
                MySo Bridge Node Configuration
              </Link>
            </HomeCard>
            <HomeCard title="About MySo">
            ...
            <HomeCard title="References" aux>
              ...
              <Link className={styles.cardLink} to="/references/myso-api">
                MySo API
              </Link>
              <Link
                className={styles.cardLink}
            ...
            <HomeCard title="Resources" aux>
              <Link
                className={styles.cardLink}
                to="https://myso.directory/?_project_type=api%2Cdeveloper-tools%2Cinfrastructure%2Csdk"
              >
                MySo Ecosystem
              </Link>
            ...
            <HomeCardCTA>
              ...
              >
                <span>Build your dApp on MySo</span>
                <svg
                  width="11"
                  height="11"
                  viewBox="0 0 11 11"
