...
export const Parameter = (props) => {
  ...
  return (
    <>
      <div className="grid grid-cols-6 ml-4 odd:bg-myso-ghost-white dark:odd:bg-myso-ghost-dark rounded-lg">
    ...
    <div className="border-b mb-8">
      {hasParams && (
        <div className="grid grid-cols-6 ml-4">
          ...
          <div className="p-2 bg-myso-blue dark:bg-myso-blue-dark text-myso-gray-95 dark:text-myso-gray-50 text-myso-gray-35 font-bold">
            Required
          </div>
          <div className="rounded-tr-lg rounded-br-lg col-span-3 p-2 bg-myso-blue dark:bg-myso-blue-dark text-myso-gray-95 dark:text-myso-gray-50 text-myso-gray-35 font-bold">
            Description
          </div>
        </div>
      )}
