        ...
        return (
          ...
          >
            <h2
              ...
              className="border-0 border-b border-solid border-myso-blue-dark dark:border-myso-blue scroll-mt-32 text-3xl text-myso-blue-dark dark:text-myso-blue font-bold mt-12 after:content-['_#'] after:hidden after:hover:inline after:opacity-20 cursor-pointer"
              onClick={handleClick}
                  ...
                  return (
                    <div
                      className={`snap-start scroll-mt-32 ${
                        method.deprecated
                          ? "bg-myso-warning-light p-8 pt-4 rounded-lg mt-8 dark:bg-myso-warning-dark"
                          : "pt-8"
                      }`}
                      key={`div-${api
                        .replaceAll(/\s/g, "-")
                    ...
                    >
                      ...
                      {method.deprecated && (
                        <div className="p-4 bg-myso-issue rounded-lg font-bold mt-4">
                          Deprecated
                        </div>
                      )}
                      <div className="">
                        ...
                        <p className="font-bold mt-4 mb-2 text-xl text-myso-grey-80 dark:text-myso-gray-70">
                          Parameters
                        </p>
                        <Parameters
                          ...
                          schemas={schemas}
                        />
                        <p className="font-bold mb-2 text-xl text-myso-gray-80 dark:text-myso-gray-70">
                          Result
                        </p>
                        <Result result={method.result} json={json} />
                        {method.examples && (
                          <>
                            <p className="mt-4 font-bold text-xl text-myso-gray-80 dark:text-myso-gray-70">
                              Example
                            </p>
