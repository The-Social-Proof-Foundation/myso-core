...
export default function CustomHitsContent({ name }) {
  ...
  if (name === "myso_docs") {
    siteToVisit = `${siteToVisit}. If you are unable to find the information you need, try one of the official MySo support channels: <a href="https://github.com/the-social-proof-foundation/myso-core/issues/new/choose" target="_blank">GitHub</a>, <a href="https://discord.gg/MySo" target="_blank">Discord</a>, or <a href="https://t.me/MySoTokenNetwork" target="_blank">Telegram</a>.`;
  } else if (name === "suins_docs") {
    siteToVisit = `${siteToVisit} or visit the official <a href="https://docs.suins.io" target="_blank">MySoNS doc</a> site.`;
  ...
  } else if (name === "myso_sdks") {
    siteToVisit = `${siteToVisit} or visit the official <a href="https://sdk.mystenlabs.com" target="_blank">MySo SDKs</a> site.`;
  ...
  return (
    <>
      {Object.entries(grouped).map(([key, group], index) => {
        return (
          <div
            className="p-6 pb-[40px] mb-6 bg-myso-gray-35 rounded-[20px]"
            key={index}
          >
            <div className="text-xl text-myso-gray-3s font-semibold mb-4">
                  ...
                  <div key={i} className="mb-2">
                    {isInternal ? (
                      <button
                        ...
                        className="text-base text-blue-600 hover:text-myso-blue underline text-left bg-transparent border-0 pl-0 cursor-pointer font-[Inter]"
                      >
                        {sectionTitle}
                      </button>
                    ) : (
                    ...
                    <p
                      className="font-normal text-base text-myso-gray-5s"
                      dangerouslySetInnerHTML={{
                        __html: hit.content
