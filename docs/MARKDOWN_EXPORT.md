...
The MySo documentation now supports viewing raw markdown versions of any documentation page by appending `.md` to the URL. This makes the documentation LLM-ready and easier to consume programmatically.
