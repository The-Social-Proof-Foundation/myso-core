...
Devnet data is wiped regularly as part of [weekly scheduled software updates](https://mysocial.network/networkinfo).
...
For more information about the release schedule of MySo networks, see [MySo Network Release](https://mysocial.network/networkinfo/).
