...
The General-purpose Indexer includes configurable checkpoint-based pipelines that extract data from the MySo remote checkpoint store and full nodes. The pipelines write processed data to a database optimized for GraphQL query access.
