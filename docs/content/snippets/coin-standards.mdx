...
<ImportContent source="crates/myso-framework/packages/myso-framework/sources/coin.move" mode="code" fun="deny_list_v2_add" noComments />
...
<ImportContent source="crates/myso-framework/packages/myso-framework/sources/coin.move" mode="code" fun="deny_list_v2_remove" noComments />
...
tx.moveCall({
    ...
    arguments: [
        tx.object(<MYSO-DENY-LIST-OBJECT-ID>),
...
- `<MYSO-DENY-LIST-OBJECT-ID>` is `"0x403"`.
...
- `cmd.address()` returns the address to ban as a `MySoAddress`.
...
<ImportContent source="crates/myso-framework/packages/myso-framework/sources/coin.move" mode="code" fun="deny_list_v2_enable_global_pause" noComments signatureOnly />
...
<ImportContent source="crates/myso-framework/packages/myso-framework/sources/coin.move" mode="code" fun="deny_list_v2_disable_global_pause" noComments signatureOnly  />