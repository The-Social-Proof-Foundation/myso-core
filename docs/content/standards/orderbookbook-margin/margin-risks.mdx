...
Liquidation in DeepBook Margin is **partial**, not total. The protocol only liquidates enough of your position to restore your risk ratio to the **Target Liquidation Risk Ratio** (1.25 for MYSO/USDC, 1.5 for WAL/USDC and DEEP/USDC).
