...
If the volume returned in the base asset for the MYSO/USDC pool is 1,000,000,000 MYSO UNIT, the correct volume in MYSO is 1,000,000,000 / 10^(SUI_SCALAR) = 1 MYSO. Similarly, if the volume returned in the quote asset for the MYSO/USDC pool is 1,000,000,000 USDC UNIT, the correct volume is  1,000,000,000 / 10^(USDC_SCALAR) = 1,000 USDC.
