...
title: Pools SDK
sidebar_label: Pools
description: Learn how to use the OrderbookV3 SDK to read the state of a pool.
keywords:
  [
    orderbook design,
    orderbookv3,
...
Pools are shared objects that represent a market. See [Query the Pool](../orderbookv3/contract-information/query-the-pool.mdx) for more information on pools.

## Pool functions

The OrderbookV3 SDK exposes functions that you can call to read the state of a pool. These functions typically require a `managerKey`, `coinKey`, `poolKey`, or a combination of these. For details on these keys, see [OrderbookV3 SDK](../orderbookv3-sdk.mdx#keys). The SDK includes some default keys that you can view in the `constants.ts` file.

:::tip SDK Unit Handling
Input amounts, quantities, and prices should be provided in standard decimal format (e.g., `10.5` MYSO, `0.00001` nBTC). The SDK handles conversion to base units internally. Returned amounts are also in standard decimal format.
:::
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="account" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="accountOpenOrders" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="checkManagerBalance" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getOrder" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getQuoteQuantityOut" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getBaseQuantityOut" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getQuantityOut" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getLevel2Range" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getLevel2TicksFromMid" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="lockedBalance" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="poolTradeParams" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="vaultBalances" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getPoolIdByAssets" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="midPrice" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="whitelisted" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="poolBookParams" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getOrders" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getPoolDeepPrice" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/transactions/orderbook.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="addDeepPricePoint" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/transactions/orderbook.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="updatePoolAllowedVersions" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/transactions/orderbook.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="createPermissionlessPool" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getBalanceManagerIds" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/transactions/orderbook.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="mintReferral" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/transactions/orderbook.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="updateReferralMultiplier" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/transactions/orderbook.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="claimReferralRewards" signatureOnly />
...
<ImportContent source="/packages/orderbook-v3/src/client.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getReferralBalances" signatureOnly />
