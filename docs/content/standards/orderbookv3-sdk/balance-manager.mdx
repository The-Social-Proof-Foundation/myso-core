...
description: Learn how to use the OrderbookV3 SDK to manage balance managers and their capabilities.
keywords:
  [
    balance manager,
    balancemanager,
...
The `BalanceManager` is a core component of OrderbookV3 that holds all asset balances. The SDK provides comprehensive functions to create, manage, and interact with balance managers.

## Balance manager functions

The OrderbookV3 SDK provides the following functions for managing balance managers.
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="createAndShareBalanceManager" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="createBalanceManagerWithOwner" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="shareBalanceManager" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="depositIntoManager" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="withdrawFromManager" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="withdrawAllFromManager" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="checkManagerBalance" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="generateProof" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="generateProofAsOwner" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="generateProofAsTrader" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="mintTradeCap" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="mintDepositCap" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="mintWithdrawalCap" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="depositWithCap" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="withdrawWithCap" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="revokeTradeCap" signatureOnly/>
...
- `managerKey`: String that identifies the balance manager.
- `referral`: String representing the referral ID (OrderbookPoolReferral).
- `tradeCap`: `TransactionArgument` representing the trade cap for permission.

<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="setBalanceManagerReferral" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="unsetBalanceManagerReferral" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getBalanceManagerReferralId" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="registerBalanceManager" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="owner" signatureOnly/>
...
<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="id" signatureOnly/>
...
Use `balanceManagerReferralOwner` to get the owner address of a pool referral (OrderbookPoolReferral). The call returns a function that takes a `Transaction` object.

**Parameters**

- `referralId`: String representing the ID of the referral.

<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="balanceManagerReferralOwner" signatureOnly/>
...
Use `balanceManagerReferralPoolId` to get the pool ID associated with a pool referral (OrderbookPoolReferral). The call returns a function that takes a `Transaction` object.

**Parameters**

- `referralId`: String representing the ID of the referral.

<ImportContent source="packages/orderbook-v3/src/transactions/balanceManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="balanceManagerReferralPoolId" signatureOnly/>
...
// Example: Withdraw MYSO from a balance manager
withdrawFunds = (tx: Transaction) => {
	const managerKey = 'MANAGER_1';
	const coinKey = 'MYSO';
	const amount = 100; // 100 MYSO
...
setManagerReferral = (tx: Transaction) => {
	const managerKey = 'MANAGER_1';
	const referralId = '0xdef...'; // OrderbookPoolReferral ID
...
<RelatedLink
	href="https://github.com/MystenLabs/ts-sdks/tree/main/packages/orderbook-v3"
	label="OrderbookV3 Indexer repository"
	desc="The OrderbookV3 SDK repository on GitHub."
/>
<RelatedLink
	href="https://www.npmjs.com/package/@mysten/orderbook-v3"
	label="OrderbookV3 SDK node package"
	desc="The OrderbookV3 SDK node package on NPM."
/>
<RelatedLink
