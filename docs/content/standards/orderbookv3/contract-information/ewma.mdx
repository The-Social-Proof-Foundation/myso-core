...
description: Learn about the Orderbook EWMA (Exponentially Weighted Moving Average) gas price penalty system.
keywords:
  [
    ewma,
    gas price,
...
Orderbook implements an exponentially weighted moving average (EWMA) system to dynamically adjust taker fees based on network gas prices. This feature helps prevent toxic takers from using high gas prices to prioritize their transactions and pick off stale maker orders.
