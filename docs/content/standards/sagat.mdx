---
title: Sagat 
description: Sagat is a multisig management platform designed for managing MySo multisig wallets.
...
[Sagat](https://github.com/MystenLabs/sagat/tree/main) is a full-stack multisig management platform for MySo multisig wallets. It is built using Bun and a TypeScript API for the backend and React for the frontend.
...
The message "No wallets found. Install a wallet (ex. Slush Wallet) to continue." indicates that you must [install the Slush extension](https://chromewebstore.google.com/detail/slush-%E2%80%94-a-myso-wallet/opcgpfmipidbgpenhmajoajpbobppdil) before continuing. 
...
Using Testnet is recommended for testing and debugging, as signing and submitting transactions use Testnet MYSO tokens that have no fiat equivalent value. Signing and submitting transactions to Mainnet costs real MYSO tokens that have a fiat equivalent value.
...
Then enter their MySo address. The address's public key is returned.
...
You can get a transaction's signature through network explorers like [MySoScan](https://suiscan.xyz/testnet/) by viewing a [transaction's details](https://suiscan.xyz/testnet/tx/GPtGkR2F7wN1TAqDJmUE3wKTBeL7e9sVuv7UTGvp9E99) and looking at the **User signature** metadata field.
