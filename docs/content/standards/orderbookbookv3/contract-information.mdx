...
description: DeepBookV3 contract addresses, supported coins, and pool information on MySo Mainnet.
keywords:
  [
    deepbook,
    deepbookv3,
...
This page contains the contract addresses, supported coins, and pool information for DeepBookV3 on MySo Mainnet.
