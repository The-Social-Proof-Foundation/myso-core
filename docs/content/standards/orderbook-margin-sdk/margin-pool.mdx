...
description: Learn how to use the Orderbook Margin SDK to supply liquidity and manage positions in margin pools.
keywords:
  [
    margin pool,
    liquidity,
...
The Orderbook Margin SDK provides the following functions for interacting with margin pools.
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginPool.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="mintSupplierCap" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginPool.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="supplyToMarginPool" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginPool.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="withdrawFromMarginPool" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginPool.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="mintSupplyReferral" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginPool.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="withdrawReferralFees" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginPool.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="getId,orderbookPoolAllowed,supplyCap,maxUtilizationRate,protocolSpread,protocolFees,minBorrow" signatureOnly />

### Supply and borrow metrics

Query current supply and borrow amounts and shares.

<ImportContent source="packages/orderbook-v3/src/transactions/marginPool.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="totalSupply,supplyShares,totalBorrow,borrowShares,lastUpdateTimestamp" signatureOnly />

### Interest rate

Query the current interest rate based on utilization.

<ImportContent source="packages/orderbook-v3/src/transactions/marginPool.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="interestRate" signatureOnly />

### User positions

Query a supplier's position in the pool.

<ImportContent source="packages/orderbook-v3/src/transactions/marginPool.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="userSupplyShares,userSupplyAmount" signatureOnly />
