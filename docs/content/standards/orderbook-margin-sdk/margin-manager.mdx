...
description: Learn how to use the Orderbook Margin SDK to manage margin accounts and leveraged positions.
keywords:
  [
    margin manager,
    margin trading,
    ...
    deposit,
    withdraw,
    orderbook margin sdk,
  ]
---

Managing margin accounts is essential for leveraged trading on Orderbook. The Margin Manager SDK provides functions for creating margin managers, depositing collateral, borrowing assets, and managing risk.

## Margin Manager functions

The Orderbook Margin SDK provides the following functions for managing margin accounts.
...
- `poolKey`: String that identifies the Orderbook pool.

<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="newMarginManager" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="newMarginManagerWithInitializer" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="shareMarginManager" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="depositBase,depositQuote,depositDeep" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="withdrawBase,withdrawQuote,withdrawDeep" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="borrowBase,borrowQuote" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="repayBase,repayQuote" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="liquidate" signatureOnly />

### `setMarginManagerReferral`

Use `setMarginManagerReferral` to set a pool-specific referral for the margin manager. The referral must be a `OrderbookPoolReferral` minted for the pool associated with the margin manager. The call returns a function that takes a `Transaction` object.
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="setMarginManagerReferral" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="unsetMarginManagerReferral" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="riskRatio" signatureOnly />

### `owner`, `orderbookPool`, `marginPoolId`

Query basic margin manager information.

<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="ownerByPoolKey,orderbookPool,marginPoolId" signatureOnly />

### `borrowedShares`, `borrowedBaseShares`, `borrowedQuoteShares`, `hasBaseDebt`

Query borrowed position information.

<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="borrowedShares,borrowedBaseShares,borrowedQuoteShares,hasBaseDebt" signatureOnly />

### `balanceManager`, `calculateAssets`, `calculateDebts`

Query balance and debt information.

<ImportContent source="packages/orderbook-v3/src/transactions/marginManager.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="balanceManager,calculateAssets,calculateDebts" signatureOnly />
...
```tsx
// Example: Deposit 100 MYSO as collateral
