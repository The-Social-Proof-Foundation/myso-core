...
description: Learn how to use the Orderbook Margin SDK to manage conditional orders for automated trading.
keywords:
  [
    take profit,
    stop loss,
...
The Orderbook Margin SDK provides the following functions for managing conditional orders.
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="addConditionalOrder" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="cancelConditionalOrder" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="cancelAllConditionalOrders" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="executeConditionalOrders" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="newCondition" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="newPendingLimitOrder" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="newPendingMarketOrder" signatureOnly />
...
<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="conditionalOrderIds" signatureOnly />

### `conditionalOrder`

Query a specific conditional order by ID.

<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="conditionalOrder" signatureOnly />

### `triggerBelowOrders`, `triggerAboveOrders`

Query the lists of conditional orders sorted by trigger price.

<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="triggerBelowOrders,triggerAboveOrders" signatureOnly />

### `numConditionalOrders`

Query the total number of conditional orders for a margin manager.

<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="numConditionalOrders" signatureOnly />

### `lowestTriggerAbovePrice`, `highestTriggerBelowPrice`

Query trigger prices for conditional orders.

<ImportContent source="packages/orderbook-v3/src/transactions/marginTPSL.ts" mode="code" org="MystenLabs" repo="ts-sdks" fun="lowestTriggerAbovePrice,highestTriggerBelowPrice" signatureOnly />
