...
sidebar_position: 2
description: DeepBook Margin contract addresses, supported coins, margin pools, and risk parameters on MySo Mainnet.
keywords:
  [
    deepbook margin,
    contract address,
...
This page contains the contract addresses, supported coins, margin pools, and risk parameters for DeepBook Margin on MySo Mainnet.
