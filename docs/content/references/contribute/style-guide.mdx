...
| ---------------------- |---------------------------------------------- | -------------- |
| **Always capitalized** | [Proper nouns](#proper-nouns), [product names](#product-names), names of example apps (Coin Flip, Blackjack, etc), Archival Store and Service, Archival Store, Archival Service, Coin Registry, Currency Standard, DeepBook Indexer, DeepBookV3, Devnet, GraphQL RPC, General-purpose Indexer, ID, Localnet, Mainnet, Mysticeti, One-Time Witness, Operation Cap,MySo, MySo CLI, MySo Client PTB CLI, MySo Closed-Loop Token / Closed-Loop Token, MySo dApp Kit, MySo Explorer, MySoJSON, MySo Keystore, MySo Keytool, MySoLink, MySo Object Display, MySoPlay0X1, MYSO, MYSO token, Testnet, Wallet Standard, Web2, Web3, zkSend SDK | Use capitalization consistently for branding and product-specific references |
