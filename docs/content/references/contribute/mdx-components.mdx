...
---
title: A Guide
description: A guide on how to do this thing in MySo.
effort: medium
---
```
...
#### Referencing files within the MySo monorepo 

Reference files via their relative path:

#### Referencing files from other repos 

If several code files located in another repo need to be referenced across multiple documentation pages, the MySo documentation team may have added it as a **submodule** of the MySo repo. Submodules are a GitHub feature that creates symlinks across repositories. 

Current submodules within the MySo docs include:

- [TS SDK](https://github.com/MystenLabs/ts-sdks): `/docs/submodules/ts-sdks`

- [Orderbook](https://github.com/MystenLabs/orderbookv3): `/docs/submodules/orderbookv3`

The MySo documentation team decides whether to add submodules. Community contributions should not attempt to add submodules.

#### How to use

1. Set the `source` argument to the relative path of the file. Do not include the `myso` root. 
