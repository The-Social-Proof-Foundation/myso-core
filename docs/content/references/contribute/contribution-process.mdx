...
Cloning the documentation locally is recommended when you are creating larger, more significant changes to the docs. See [MySo Environment Setup](./myso-environment.mdx) for instructions on forking and cloning the MySo repository. Documentation is located in the `docs/content` directory.
...
1. Submit a PR to the `main` branch of the MySo repository.  
