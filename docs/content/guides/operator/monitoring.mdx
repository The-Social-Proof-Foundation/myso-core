---
title: MySo Node Monitoring
description: Monitor MySo node metrics to ensure the health and performance of your node.
...
```sh
$ curl -s http://localhost:9184/metrics | grep -E 'myso_validator|myso_fullnode'
```
