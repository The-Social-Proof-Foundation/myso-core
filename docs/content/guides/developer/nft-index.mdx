---
title: NFTs
description: Learn how to design, build, and extend NFTs onMySo, including soulbound tokens, rental mechanics, and asset tokenization.
keywords: [ nft, nfts, soulbound nft, nft rental, asset tokenization, digital assets, myso nft ]
pagination_prev: null
---

Learn how to create and extend non-fungible tokens on MySo. 
