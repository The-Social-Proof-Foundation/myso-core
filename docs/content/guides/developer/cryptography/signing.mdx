---
title: MySo On-Chain Signatures Verification in Move
description: MySo supports verification within Move smart contracts through several signature schemes. Signature schemes include Ed25519, Secp256k1 recoverable, Secp256k1 non-recoverable, Secp256r1 non-recoverable, Secp256r1 recoverable, BLS G1, and BLS G2.
...
Move contracts in MySo support verifications for several signature schemes on-chain. Not all signatures supported in on-chain verification are supported as user signature verification. See [MySo Signatures](/concepts/transactions/transaction-auth.mdx) for valid signature schemes for transaction authorization.
