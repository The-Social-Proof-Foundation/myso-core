---
title: Hashing
description: MySo supports SHA2-256, SHA3-256, Keccak256, and Blake2b-256 cryptographic hash functions.
...
The MySo Move API supports the following cryptographic hash functions:

* SHA2-256 as `std::hash::sha2_256`
* SHA3-256 as `std::hash::sha3_256`
* Keccak256 as `myso::hash::keccak256`
* Blake2b-256 as `myso::hash::blake2b256`
