...
#### Why did MySo choose AWS Nitro Enclaves initially?
...
- It is stored as part of the MySo framework and used to verify AWS attestation documents. You can verify its hash by following the steps outlined on [AWS](https://docs.aws.amazon.com/enclaves/latest/user/verify-root.html#validation-process).

```sh
$ curl https://raw.githubusercontent.com/the-social-proof-foundation/myso-core/refs/heads/main/crates/myso-types/src/nitro_root_certificate.pem -o cert_sui.pem
...
6eb9688305e4bbca67f44b59c29a0661ae930f09b5945b5d1d9ae01125c8d6c0 # check it matches from the one downloaded from the MySo repo
```
