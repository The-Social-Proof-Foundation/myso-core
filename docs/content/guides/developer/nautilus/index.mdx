...
It currently supports self-managed [AWS Nitro Enclave TEEs](https://aws.amazon.com/ec2/nitro/nitro-enclaves/). You can verify AWS-signed enclave attestations on-chain using MySo smart contracts written in Move. Refer to the [Github repo](https://github.com/MystenLabs/nautilus) for the reproducible build template.
...
- MySo smart contracts verify the attestation on-chain before accepting the TEE output.
...
Nautilus will support additional TEE providers in the future. Your suggestions on which platforms to prioritize or support is greatly appreciated. Contact the Nautilus team on [MySo Discord](https://discord.com/channels/916379725201563759/1361500579603546223).
