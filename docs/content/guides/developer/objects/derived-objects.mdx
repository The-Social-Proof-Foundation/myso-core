...
- Conditional object creation based on received assets, such as creation of an object only after receiving MYSO
...
<ImportContent source="crates/myso-framework/packages/myso-framework/sources/derived_object.move" mode="code" />
</details>
...
<RelatedLink href="https://github.com/the-social-proof-foundation/myso-core/tree/main/examples/move/profiles" label="Profiles example" desc="An example smart contract that creates profiles using derived objects." />
...
<RelatedLink href="https://mystenlabs.github.io/myso/myso_types/derived_object/index.html" label="Rust SDK helper" desc="Helper function for the Rust SDK." />
<RelatedLink href="https://github.com/the-social-proof-foundation/myso-core/blob/main/crates/myso-framework/packages/myso-framework/sources/derived_object.move" label="`derived_object` module" desc="The code that defines derived objects on MySo." />