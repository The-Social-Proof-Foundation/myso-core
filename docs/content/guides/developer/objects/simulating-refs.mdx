...
description: Use the borrow module in the MySo framework to include objects by reference in your programmable transaction blocks.
keywords: [ borrow module, myso framework, objects, immutable reference, mutable reference, MySo API, references, simulate a reference, simulate references ]
---


Everything on the MySo blockchain is an object. When you develop Move packages for the MySo network, you typically manipulate or use on-chain objects in some way through functionality available in the MySo API. For most API functions, you provide an object by reference.

References are a key construct when programming in Move and on MySo. Most of the functionality available in the MySo API takes objects by reference.
