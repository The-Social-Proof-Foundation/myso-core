...
<RelatedLink href="https://github.com/the-social-proof-foundation/myso-core/tree/main/examples/move/nft-rental" label="NFT Rental example" desc="The source code that this document references." />
