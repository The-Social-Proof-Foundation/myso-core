...
const guides = [
    ...
    items: [
      {
        ...
        link: {
          type: 'doc',
          id: 'guides/developer/getting-started/myso-install',
        },
        items: [
      ...
      'guides/developer/getting-started/configure-myso-client',
  ...
  },
  {
    ...
    label: 'Wallets',
    items: [
      'guides/developer/wallets/mysolink',
    ],
  },
  {
    type: 'category',
  ...
  'guides/developer/common-errors',
  {
    ...
    items: [
      'guides/operator/myso-full-node',
  ...
  },
  {
    ...
    link: {
      type: 'doc',
      id: 'guides/mysoplay0x1',
    },
    items: [
      'guides/mysoplay0x1/integration',
      'guides/mysoplay0x1/migration-strategies',
      'guides/mysoplay0x1/wallet-integration',
      'guides/mysoplay0x1/best-practices',
    ],
  },
];
