...
contract CommitteeUpgradeableTest is BridgeBaseTest {
    ...
    function setUp() public {
        ...
        address _config = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                ...
                (_committee, _chainID, supportedTokens, tokenPrices, tokenIds, mysoDecimals, _supportedDestinationChains)
            ),
            opts
        );
        ...
        address _bridge = Upgrades.deployUUPSProxy(
            "MySoBridge.sol",
            abi.encodeCall(MySoBridge.initialize, (_committee, address(0), address(0))),
            opts
        );

        bridge = MySoBridge(_bridge);
        bridgeV2 = new MockMySoBridgeV2();
    }

    function testUpgradeWithSignaturesSuccess() public {
        bytes memory initializer = abi.encodeCall(MockMySoBridgeV2.initializeV2, ());
    ...
    function testUpgradeRegressionTestWith1CalldataArg() public {
        ...
        MockMySoBridgeV2 newBridgeV2 = MockMySoBridgeV2(address(bridge));
    ...
    function testUpgradeRegressionTestWithNoCalldata() public {
        ...
        MockMySoBridgeV2(address(bridge));
        assertEq(Upgrades.getImplementationAddress(address(bridge)), address(bridgeV2));
    }
}
