...
contract MySoBridgeV2Test is BridgeBaseTest {
    MySoBridgeV2 bridgeV2;
    uint8 _chainID = 12;
    ...
    function _deployBridgeV2() internal {
        ...
        // deploy MySoBridgeV2 directly (not upgrading from V1)
        ...
        bridgeV2 = MySoBridgeV2(_bridgeV2);
    ...
    function testBridgeETHV2() public {
        ...
        emit TokensDepositedV2(
            ...
            BridgeUtils.ETH,
            1_00_000_000, // 1 ether in myso decimals
            deployer,
    ...
    function testBridgeETHV2InvalidRecipientAddress() public {
        vm.expectRevert(bytes("MySoBridge: Invalid recipient address length"));
        bridgeV2.bridgeETHV2{value: 1 ether}(
    ...
    function testBridgeERC20V2UnsupportedToken() public {
        vm.expectRevert(bytes("MySoBridge: Unsupported token"));
        bridgeV2.bridgeERC20V2(
    ...
    function testBridgeERC20V2InsufficientAllowance() public {
        vm.expectRevert(bytes("MySoBridge: Insufficient allowance"));
        bridgeV2.bridgeERC20V2(
            BridgeUtils.ETH,
            type(uint256).max,
            hex"06bb77410cd326430fa2036c8282dbb54a6f8640cea16ef5eff32d638718b3e4",
    ...
    function testTransferBridgedTokensWithSignaturesV2() public {
        ...
        bytes memory payload = _createV2TransferPayload(
            ...
            BridgeUtils.ETH,
            100000000,
            block.timestamp // 1 ether in myso decimals
        );
    ...
    function testTransferBridgedTokensV2InvalidVersion() public {
        ...
        vm.expectRevert(bytes("MySoBridge: Invalid message version"));
        bridgeV2.transferBridgedTokensWithSignaturesV2(signatures, message);
    }
    ...
    function testTransferBridgedTokensV2MessageAlreadyProcessed() public {
        ...
        vm.expectRevert(bytes("MySoBridge: Message already processed"));
        bridgeV2.transferBridgedTokensWithSignaturesV2(signatures, message);
    }
    ...
    function testMatureMessageBypassesLimit() public {
        ...
        uint64 largeAmount = 100_00000000; // 100 ETH in myso decimals
    ...
    function testFreshMessageRespectsLimit() public {
        ...
        // totalLimit is 1_000_000 USD, ETH price ~$2597, so ~386 ETH exceeds limit
        uint64 largeAmount = 400_00000000; // 400 ETH in myso decimals - exceeds $1M limit
        ...
        vm.expectRevert(bytes("MySoBridge: Amount exceeds bridge limit"));
        bridgeV2.transferBridgedTokensWithSignaturesV2(signatures, message);
    }
    ...
    function testMatureUSDCTransferBypassesLimit() public {
        ...
        uint64 largeAmount = 1_500_000_000000; // $1.5M USDC in myso decimals (6 decimals)
    ...
    function testV1TransferStillWorksOnV2() public {
        ...
        uint64 amount = 100000000; // 1 ether in myso decimals
    ...
    function testUpgradeFromV1ToV2() public {
        ...
        MySoBridge bridgeV1 = MySoBridge(_bridgeV1);
        ...
        MySoBridgeV2 v2Implementation = new MySoBridgeV2();
        ...
        MySoBridgeV2 upgradedBridge = MySoBridgeV2(address(bridgeV1));
