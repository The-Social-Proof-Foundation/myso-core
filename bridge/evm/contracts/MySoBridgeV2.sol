...
import "./MySoBridge.sol";
import "./utils/BridgeUtilsV2.sol";

contract MySoBridgeV2 is MySoBridge {
    /* ========== EXTERNAL FUNCTIONS ========== */
        ...
        onlySupportedChain(message.chainID)
    {
        ...
        require(message.version == 2, "MySoBridge: Invalid message version");
    ...
    /// @param mysoAdjustedAmount The amount of tokens to transfer, adjusted for MySo decimals.
