...
interface IBridgeConfig {
    ...
    function tokenMySoDecimalOf(uint8 tokenID) external view returns (uint8);
    ...
    /// @param mysoDecimals The added token's decimal places on MySo.
    ...
    event TokenAdded(uint8 tokenID, address tokenAddress, uint8 mysoDecimal, uint64 tokenPrice);
