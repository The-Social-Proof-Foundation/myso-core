...
for example, /opt/myso, it assumes snapshots are staged in /opt/myso/snapshots,
and all symlinks to said snapshots are contained under /opt/myso/instances. It will delete all snapshots that are not
...
def usage():
    ...
    print(
        f'   --dir=<myso-base-dir>   Base directory for myso. Must contain /snapshots and /instances dirs')
