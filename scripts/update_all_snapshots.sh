...
cd "$ROOT/crates/myso-core" && cargo insta test -- snapshot_tests
cd "$ROOT/crates/myso-types" && cargo insta test
cd "$ROOT/crates/myso-indexer-alt-graphql" && cargo insta test -- test_schema_sdl_export
cd "$ROOT/crates/myso-indexer-alt-graphql" && cargo insta test --features staging -- test_schema_sdl_export
exit 0
