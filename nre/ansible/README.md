# Configure a Linux system as a MySo Node using Ansible

This is a self contained Ansible role for configuring a Linux system as a MySo Node.
...
3. Update the `myso_release` var in the [Ansible Inventory](./inventory.yaml)
...
`ansible-playbook -i inventory.yaml myso-node.yaml -e host=$inventory_name`
