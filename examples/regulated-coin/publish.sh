...
NETWORK="https://rpc.testnet.myso.io:443"
FAUCET="https://faucet.testnet.myso.io/gas"
    
myso client switch --env testnet

ADMIN_ADDRESS=$(myso client active-address)

echo "- Publisher Address is: ${ADMIN_ADDRESS}"

publish_res=$(myso client publish --json ${MOVE_PACKAGE_PATH})
