...
/// Rust representation of a Move `shared::Game`, mysotable for deserializing from their BCS
/// representation.
#[derive(Deserialize)]
...
/// Rust representation of a Move `owned::Game`, mysotable for deserializing from their BCS
/// representation.
#[derive(Deserialize)]
