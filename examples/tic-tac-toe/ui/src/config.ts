...
const { networkConfig, useNetworkVariable } = createNetworkConfig({
    ...
    devnet: {
        ...
        variables: {
            explorer: (id: string) => `https://mysoscan.xyz/devnet/object/${id}/`,
            ...DevnetPackage,
        },
    },
    testnet: {
        ...
        variables: {
            explorer: (id: string) => `https://mysoscan.xyz/testnet/object/${id}/`,
            ...TestnetPackage,
        },
    },
    mainnet: {
        ...
        variables: {
            explorer: (id: string) => `https://mysoscan.xyz/mainnet/object/${id}/`,
            ...MainnetPackage,
        },
    },
});
