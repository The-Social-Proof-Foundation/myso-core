...
import { useSignAndExecuteTransaction, useMySoClient } from "@mysten/dapp-kit";
import { MySoClient, MySoTransactionBlockResponse } from "@mysten/myso/client";
import { Transaction } from "@mysten/myso/transactions";

type Options = Omit<Parameters<MySoClient["getTransactionBlock"]>[0], "digest"> & {
    tx: Transaction;
};
...
type ResponseCallback = (tx: MySoTransactionBlockResponse) => void | Promise<void>;
