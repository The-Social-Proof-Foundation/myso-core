...
public fun make_payment(payment_id: u64, coin: Coin<MYSO>, to: address, ctx: &mut TxContext) {
...
public fun unpack(identified_payment: IdentifiedPayment): (u64, Coin<MYSO>) {
...
/// `myso::transfer::receive` function can only be called on the object from
