...
module examples::sword {
    ...
    use myso::token::{Self, Token, ActionRequest};
...
/// MYSO and used to buy swords (in the `sword` module).
module examples::gem {
    use std::option::none;
    ...
    /// 10 MYSO is the price of a small bundle of Gems.
    const SMALL_BUNDLE: u64 = 10_000_000_000;
    const SMALL_AMOUNT: u64 = 100;

    /// 100 MYSO is the price of a medium bundle of Gems.
    const MEDIUM_BUNDLE: u64 = 100_000_000_000;
    const MEDIUM_AMOUNT: u64 = 5_000;

    /// 1000 MYSO is the price of a large bundle of Gems.
