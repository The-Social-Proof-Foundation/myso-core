# ClickHouse MySo Indexer

A simple example of how to build a custom MySo indexer that writes transaction data to ClickHouse.
...
```bash
cargo run -- --remote-store-url https://storage.googleapis.com/mysocial-testnet-checkpoints --last-checkpoint=10
```
