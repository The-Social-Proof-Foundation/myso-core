...
use myso_indexer_alt_framework::types::collection_types::VecMap;
use myso_indexer_alt_framework::types::dynamic_field::Field;
use myso_indexer_alt_framework::types::id::UID;
use myso_indexer_alt_framework::types::object::{Object, Owner};
...
pub fn extract_content_from_metadata(
    tag: &StructTag,
    object: &Object,
) -> anyhow::Result<Option<(BlogPostMetadata, MySoAddress)>> {
    ...
    let publisher = MySoAddress::from_str(publisher)
