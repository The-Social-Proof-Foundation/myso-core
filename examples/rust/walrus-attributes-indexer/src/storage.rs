...
/// Representation of a row from the `blog_post` table, which maps a blob to its associated MySo Blob
...
pub struct StoredBlogPost {
    ...
    /// ID of the Blob object on MySo, used during reads to fetch the actual blob content. If this
