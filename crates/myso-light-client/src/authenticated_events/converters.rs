...
pub(super) fn proto_object_ref_to_myso_object_ref(
...
) -> Result<myso_types::base_types::ObjectRef, ClientError> {
    ...
    let digest = myso_types::digests::ObjectDigest::from_str(digest_str)
...
pub(super) fn proto_ocs_inclusion_proof_to_light_client_proof(
    ...
    let tree_root = myso_types::digests::Digest::new(tree_root_arr);
