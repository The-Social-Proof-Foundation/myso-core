...
use myso_rpc_api::proto::myso::rpc::v2::{GetCheckpointRequest, GetEpochRequest};
use myso_types::accumulator_root::{EventStreamHead, derive_event_stream_head_object_id};
...
pub struct AuthenticatedEvent {
    /// The underlying MySo event data.
    pub event: Event,
...
impl TryFrom<myso_rpc_api::grpc::alpha::event_service_proto::AuthenticatedEvent>
    for AuthenticatedEvent
{
    type Error = ClientError;

    fn try_from(
        event: myso_rpc_api::grpc::alpha::event_service_proto::AuthenticatedEvent,
...
impl AuthenticatedEventsClient {
    ...
    fn extract_stream_head_from_object(
        object: &myso_types::object::Object,
    ) -> Result<EventStreamHead, ClientError> {
        match &object.data {
            myso_types::object::Data::Move(move_obj) => {
            ...
            myso_types::object::Data::Package(_) => Err(ClientError::InternalError(
    ...
    /// # use myso_types::base_types::MySoAddress;
    /// # async fn example(client: Arc<AuthenticatedEventsClient>, stream_id: MySoAddress) {
    ...
    pub(crate) async fn fetch_and_verify_stream_head(
        &self,
        stream_object_id: myso_types::base_types::ObjectID,
        checkpoint: u64,
    ) -> Result<EventStreamHead, ClientError> {
        ...
        let mut request =
            myso_rpc_api::grpc::alpha::proof_service_proto::GetObjectInclusionProofRequest::default(
            );
        ...
        let object: myso_types::object::Object = bcs::from_bytes(object_data_bytes)?;
    ...
    async fn fetch_current_stream_head_and_verify(
        ...
        let mut request = myso_rpc_api::proto::myso::rpc::v2::GetObjectRequest::default();
        request.object_id = Some(stream_object_id.to_string());
    ...
    async fn fetch_and_verify_next_epoch(
        ...
        let checkpoint: myso_types::full_checkpoint_content::Checkpoint =
    ...
    fn verify_ocs_inclusion_proof(
        &self,
        committee: &Committee,
        response: &myso_rpc_api::grpc::alpha::proof_service_proto::GetObjectInclusionProofResponse,
    ) -> Result<(), ClientError> {
        ...
        let checkpoint_summary: myso_types::messages_checkpoint::CertifiedCheckpointSummary =
        ...
        let object_ref = converters::proto_object_ref_to_myso_object_ref(object_ref_proto)?;
