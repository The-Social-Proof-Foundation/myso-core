...
impl MetricsPushClient {
    pub fn new(metrics_key: myso_types::crypto::NetworkKeyPair) -> Self {
        use fastcrypto::traits::KeyPair;
        let certificate = std::sync::Arc::new(myso_tls::SelfSignedCertificate::new(
            metrics_key.private(),
            myso_tls::MYSO_VALIDATOR_SERVER_NAME,
        ));
