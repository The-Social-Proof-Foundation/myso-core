...
use myso_config::p2p::{AccessType, DiscoveryConfig, P2pConfig};
use myso_types::crypto::{NetworkKeyPair, Signer, ToFromBytes, VerifyingKey};
...
mod generated {
    include!(concat!(env!("OUT_DIR"), "/myso.Discovery.rs"));
}
mod builder;
mod metrics;
mod server;
