...
pub const CHECKPOINTS_PIPELINE: &str =
    <BigTableHandler<CheckpointsPipeline> as myso_indexer_alt_framework::pipeline::Processor>::NAME;
pub const CHECKPOINTS_BY_DIGEST_PIPELINE: &str =
    <BigTableHandler<CheckpointsByDigestPipeline> as myso_indexer_alt_framework::pipeline::Processor>::NAME;
pub const TRANSACTIONS_PIPELINE: &str =
    <BigTableHandler<TransactionsPipeline> as myso_indexer_alt_framework::pipeline::Processor>::NAME;
pub const OBJECTS_PIPELINE: &str =
    <BigTableHandler<ObjectsPipeline> as myso_indexer_alt_framework::pipeline::Processor>::NAME;
pub const OBJECT_TYPES_PIPELINE: &str =
    <BigTableHandler<ObjectTypesPipeline> as myso_indexer_alt_framework::pipeline::Processor>::NAME;
pub const EPOCH_START_PIPELINE: &str =
    <BigTableHandler<EpochStartPipeline> as myso_indexer_alt_framework::pipeline::Processor>::NAME;
pub const EPOCH_END_PIPELINE: &str =
    <BigTableHandler<EpochEndPipeline> as myso_indexer_alt_framework::pipeline::Processor>::NAME;
pub const EPOCH_LEGACY_PIPELINE: &str =
    <EpochLegacyPipeline as myso_indexer_alt_framework::pipeline::Processor>::NAME;
...
use myso_indexer_alt_framework::pipeline::concurrent::ConcurrentConfig;
use myso_types::balance_change::BalanceChange;
use myso_types::base_types::ObjectID;
use myso_types::base_types::ObjectType;
...
pub struct EpochData {
    ...
    pub system_state: Option<myso_types::myso_system_state::MySoSystemState>,
...
impl From<myso_indexer_alt_framework_store_traits::CommitterWatermark> for Watermark {
    fn from(w: myso_indexer_alt_framework_store_traits::CommitterWatermark) -> Self {
        Self {
...
impl From<Watermark> for myso_indexer_alt_framework_store_traits::CommitterWatermark {
