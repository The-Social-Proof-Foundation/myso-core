...
#[derive(Parser)]
#[command(name = "myso-kvstore-alt")]
#[command(about = "KVStore indexer using myso-indexer-alt-framework")]
struct Args {
...
async fn main() -> Result<()> {
    ...
    let metrics_service =
        myso_indexer_alt_metrics::MetricsService::new(args.metrics_args, registry.clone());
