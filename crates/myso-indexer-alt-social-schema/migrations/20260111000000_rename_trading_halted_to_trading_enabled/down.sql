...
DROP INDEX IF EXISTS idx_spt_exchange_config_trading_enabled;
...
CREATE INDEX IF NOT EXISTS idx_spt_exchange_config_trading_halted ON spt_exchange_config(trading_halted);
