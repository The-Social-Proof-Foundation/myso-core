...
ALTER TABLE poc_configuration DROP COLUMN IF EXISTS dispute_second_round_quorum_multiplier_bps;
ALTER TABLE poc_configuration DROP COLUMN IF EXISTS dispute_second_round_fee_multiplier_bps;
ALTER TABLE poc_configuration DROP COLUMN IF EXISTS dispute_quorum_base_stake;
