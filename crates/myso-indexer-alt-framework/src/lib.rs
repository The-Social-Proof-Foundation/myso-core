...
pub use myso_field_count::FieldCount;
pub use myso_futures::service;
/// External users access the store trait through framework::store
pub use myso_indexer_alt_framework_store_traits as store;
...
mod tests {
    ...
    use myso_synthetic_ingestion::synthetic_ingestion;
    ...
    impl Processor for ControllableHandler {
        ...
        async fn process(
            &self,
            checkpoint: &Arc<myso_types::full_checkpoint_content::Checkpoint>,
