...
use myso_package_management::PublishedAtError;
use myso_types::{base_types::ObjectID, error::MySoObjectResponseError};
...
pub enum Error {
    ...
    #[error("Dependency ID contains a MySo object, not a Move package: {0}")]
    ...
    MySoObjectRefFailure(MySoObjectResponseError),
