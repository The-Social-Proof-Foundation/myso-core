...
use myso_json_rpc_types::{
    DynamicFieldPage, EventFilter, EventPage, ObjectsPage, Page, MySoEvent, MySoObjectResponse,
...
#[open_rpc(namespace = "mysox", tag = "Extended API")]
...
pub trait IndexerApi {
    ...
    async fn query_events(
        &self,
        /// The event query criteria. See [Event filter](https://docs.myso.io/build/event_api#event-filters) documentation for examples.
        query: EventFilter,
    ...
    /// Subscribe to a stream of MySo event
    #[subscription(name = "subscribeEvent", item = MySoEvent)]
    fn subscribe_event(
        &self,
        /// The filter criteria of the event stream. See [Event filter](https://docs.myso.io/build/event_api#event-filters) documentation for examples.
        filter: EventFilter,
    ) -> SubscriptionResult;

    /// Subscribe to a stream of MySo transaction effects
    #[subscription(name = "subscribeTransaction", item = MySoTransactionBlockEffects)]
