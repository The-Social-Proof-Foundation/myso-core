...
use myso_json_rpc_types::{Balance, CoinPage, MySoCoinMetadata};
use myso_open_rpc_macros::open_rpc;
use myso_types::balance::Supply;
use myso_types::base_types::MySoAddress;

#[open_rpc(namespace = "mysox", tag = "Coin Query API")]
...
pub trait CoinReadApi {
    ...
    async fn get_coins(
        ...
        owner: MySoAddress,
        /// optional type name for the coin (e.g., 0x168da5bf1f48dafc111b0a488fa454aca95e0b5e::usdc::USDC), default to 0x2::myso::MYSO if not specified.
