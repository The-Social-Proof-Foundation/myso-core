...
pub use orderbook::OrderbookApiClient;
pub use orderbook::OrderbookApiOpenRpc;
pub use orderbook::OrderbookApiServer;
...
pub struct JsonRpcMetrics {
    ...
    pub get_stake_myso_result_size: Histogram,
    pub get_stake_myso_result_size_total: IntCounter,

    pub get_stake_myso_latency: Histogram,
    pub get_delegated_myso_latency: Histogram,
...
impl JsonRpcMetrics {
    pub fn new(registry: &prometheus::Registry) -> Self {
        Self {
            ...
            .unwrap(),
            get_stake_myso_result_size: register_histogram_with_registry!(
                "json_rpc_get_stake_myso_result_size",
                "The return size for get_stake_myso",
                mysten_metrics::COUNT_BUCKETS.to_vec(),
                registry,
            )
            .unwrap(),
            get_stake_myso_result_size_total: register_int_counter_with_registry!(
                "json_rpc_get_stake_myso_result_size_total",
                "The total return size for get_stake_myso",
                registry
            )
            .unwrap(),
            get_stake_myso_latency: register_histogram_with_registry!(
                "get_stake_myso_latency",
                "The latency of get stake myso, in ms",
                mysten_metrics::COARSE_LATENCY_SEC_BUCKETS.to_vec(),
                registry,
            )
            .unwrap(),
            get_delegated_myso_latency: register_histogram_with_registry!(
                "get_delegated_myso_latency",
                "The latency of get delegated myso, in ms",
                mysten_metrics::COARSE_LATENCY_SEC_BUCKETS.to_vec(),
                registry,
            )
            .unwrap(),
