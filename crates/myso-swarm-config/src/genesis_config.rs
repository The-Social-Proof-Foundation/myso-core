...
pub struct ValidatorGenesisConfig {
    ...
    #[serde(default = "default_myso_key_pair")]
    pub account_key_pair: MySoKeyPair,
    #[serde(default = "default_ed25519_key_pair")]
...
impl ValidatorGenesisConfig {
    pub fn to_validator_info(&self, name: String) -> GenesisValidatorInfo {
        ...
        let info = ValidatorInfo {
            ...
            worker_key,
            network_key,
            account_address: MySoAddress::from(&account_key),
...
fn default_myso_key_pair() -> MySoKeyPair {
    MySoKeyPair::Ed25519(get_key_pair_from_rng(&mut rand::rngs::OsRng).1)
}

#[derive(Serialize, Deserialize, Debug, Clone)]
pub struct AccountConfig {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<MySoAddress>,
...
impl GenesisConfig {
    ...
    pub fn for_local_testing_with_addresses(addresses: Vec<MySoAddress>) -> Self {
    ...
    pub fn benchmark_gas_keys(n: usize) -> Vec<MySoKeyPair> {
        let mut rng = StdRng::seed_from_u64(Self::BENCHMARKS_RNG_SEED);
        (0..n)
            .map(|_| MySoKeyPair::Ed25519(NetworkKeyPair::generate(&mut rng)))
            .collect()
    }
