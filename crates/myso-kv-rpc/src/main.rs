...
async fn main() -> Result<()> {
    ...
    let server_version = Some(ServerVersion::new("myso-kv-rpc", VERSION));
    ...
    let reflection_v1 = tonic_reflection::server::Builder::configure()
        .register_encoded_file_descriptor_set(
            myso_rpc_api::proto::google::protobuf::FILE_DESCRIPTOR_SET,
        )
        .register_encoded_file_descriptor_set(myso_rpc_api::proto::google::rpc::FILE_DESCRIPTOR_SET)
        .register_encoded_file_descriptor_set(myso_rpc::proto::myso::rpc::v2::FILE_DESCRIPTOR_SET)
        .build_v1()?;
    ...
    builder
        ...
        .add_service(
            myso_rpc::proto::myso::rpc::v2::ledger_service_server::LedgerServiceServer::new(server),
        )
