...
use myso_rpc::proto::myso::rpc::v2::ProtocolConfig as RpcProtocolConfig;
use myso_rpc::proto::myso::rpc::v2::{GetEpochRequest, GetEpochResponse};
use myso_rpc_api::{
    ErrorReason,
...
pub async fn get_epoch(
    ...
    chain: Chain,
) -> myso_rpc_api::Result<GetEpochResponse> {
    let read_mask = {
