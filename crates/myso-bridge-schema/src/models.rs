...
use crate::schema::{
    governance_actions, progress_store, myso_error_transactions, myso_progress_store, token_transfer,
    token_transfer_data,
};
...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug)]
#[diesel(table_name = myso_progress_store, primary_key(txn_digest))]
pub struct MySoProgressStore {
...
pub struct MySoErrorTransactions {
    pub txn_digest: Vec<u8>,
    pub sender_address: Vec<u8>,
    pub timestamp_ms: i64,
