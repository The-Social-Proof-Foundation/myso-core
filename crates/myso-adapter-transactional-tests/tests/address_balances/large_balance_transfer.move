...
//# programmable --sender A --inputs withdraw<myso::balance::Balance<test::large_balance::MARKER>>(18446744073709551615) @B
//> 0: myso::balance::redeem_funds<test::large_balance::MARKER>(Input(0));
//> 1: myso::balance::send_funds<test::large_balance::MARKER>(Result(0), Input(1));
...
//# programmable --sender A --inputs withdraw<myso::balance::Balance<test::large_balance::MARKER>>(18446744073709551615) withdraw<myso::balance::Balance<test::large_balance::MARKER>>(18446744073709551615) @B
//> 0: myso::balance::redeem_funds<test::large_balance::MARKER>(Input(0));
//> 1: myso::balance::redeem_funds<test::large_balance::MARKER>(Input(1));
//> 2: myso::balance::join<test::large_balance::MARKER>(Result(0), Result(1));
//> 3: myso::balance::send_funds<test::large_balance::MARKER>(Result(0), Input(2));
