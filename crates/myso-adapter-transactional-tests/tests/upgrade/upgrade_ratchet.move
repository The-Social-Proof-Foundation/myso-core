...
//# run myso::package::only_additive_upgrades --args object(1,1) --sender A
...
//# run myso::package::only_dep_upgrades --args object(1,1) --sender A
...
//# run myso::package::make_immutable --args object(1,1) --sender A
