...
//> 0: myso::coin::mint<ex::m::M>(Input(0), Input(1));
//> 1: myso::coin::mint<ex::m::M>(Input(0), Input(1));
//> 2: TransferObjects([Result(0)], Input(2));
//> 3: myso::party::single_owner(Input(2));
//> myso::transfer::public_party_transfer<myso::coin::Coin<ex::m::M>>(Result(1), Result(3))
