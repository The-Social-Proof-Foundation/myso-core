...
module t2::o2 {
    ...
    public fun mint_owned_coin(ctx: &mut TxContext) {
        transfer::public_transfer(coin::zero<MYSO>(ctx), @A)
    }

    public fun deleter(o2: Coin<MYSO>) {
        coin::destroy_zero(o2);
    }

    public fun freezer(o2: Coin<MYSO>) {
        transfer::public_freeze_object(o2);
    }

    public fun dofer(parent: &mut Obj2, o2: Coin<MYSO>) {
        dof::add(&mut parent.id, 0u64, o2);
    }

    public fun dfer(parent: &mut Obj2, o2: Coin<MYSO>) {
        df::add(&mut parent.id, 0u64, o2);
    }

    public fun transferer(o2: Coin<MYSO>) {
        transfer::public_transfer(o2, @0x0);
    }

    public fun sharer(o2: Coin<MYSO>) {
