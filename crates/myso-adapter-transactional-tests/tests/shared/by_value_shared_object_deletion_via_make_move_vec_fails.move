...
module t2::o2 {
    ...
    public fun pop_coin(mut o2: vector<Coin<MYSO>>): Coin<MYSO> {
    ...
    public fun share_coin(o2: Coin<MYSO>) {
...
//> 2: SplitCoins(Result(1), [Input(0)]);
//> 3: TransferObjects([Result(2)], Input(2));
//> 4: myso::transfer::public_share_object<myso::coin::Coin<myso::myso::MYSO>>(Input(1));
