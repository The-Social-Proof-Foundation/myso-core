...
//> 0: test::m::mut_id();
//> test::m::gen_mut<myso::tx_context::TxContext>(Result(0));

//# programmable --dev-inspect
// cannot manually supply the TxContext, even when generic
//> 0: test::m::mut_id();
//> test::m::gen_imm<myso::tx_context::TxContext>(Result(0));
...
//> 0: test::m::mut_id();
//> test::m::gen_mut_tx<myso::tx_context::TxContext>(Result(0),Result(0));

//# programmable --dev-inspect
// cannot manually supply the TxContext, even when multiple supplied
//> 0: test::m::mut_id();
//> test::m::gen_imm_tx<myso::tx_context::TxContext>(Result(0),Result(0));
...
//> 0: test::m::mut_id();
//> test::m::gen_mut_tx<myso::tx_context::TxContext>(Result(0));

//# programmable --dev-inspect
// cannot manually supply the TxContext, even when generic and inferred
//> 0: test::m::mut_id();
//> test::m::gen_imm_tx<myso::tx_context::TxContext>(Result(0));
