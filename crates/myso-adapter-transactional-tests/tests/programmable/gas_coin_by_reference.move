...
//> test::m1::t1<myso::coin::Coin<myso::myso::MYSO>>(Gas)

//# programmable --sender A
//> test::m1::t2<myso::coin::Coin<myso::myso::MYSO>>(Gas)

//# programmable --sender A
//> test::m1::t2<myso::coin::Coin<myso::myso::MYSO>>(Gas)

//# programmable --sender A
//> test::m1::t4<myso::coin::Coin<myso::myso::MYSO>>(Gas)

//# programmable --sender A
//> test::m1::t5<myso::coin::Coin<myso::myso::MYSO>>(Gas)

//# programmable --sender A
//> test::m1::t6<myso::coin::Coin<myso::myso::MYSO>>(Gas)
