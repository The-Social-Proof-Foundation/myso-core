...
module test::m1 {
    ...
    public fun transfer_(v: vector<coin::Coin<myso::myso::MYSO>>, r: address) {
        v.do!(|c| {
...
//# run myso::pay::split_and_transfer --type-args myso::myso::MYSO --args object(2,0) 1000 @A --sender A
...
//> 0: test::m1::ret_one_amount();
//> 1: SplitCoins(Input(0), [Result(0), Input(1)]);
//> 2: MakeMoveVec<myso::coin::Coin<myso::myso::MYSO>>([NestedResult(1,0), NestedResult(1,1)]);
