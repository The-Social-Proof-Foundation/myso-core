...
public fun share(ctx: &mut TxContext) {
    myso::transfer::share_object(Shared { id: object::new(ctx) })
}
...
public fun heat_val<T>(t: T, obj: Shared): T {
    myso::transfer::share_object(obj);
    t
}
...
entry fun play_coin(_: &Coin<MYSO>) {}
entry fun play_u64(_: u64) {}
entry fun play_receiving(_: myso::transfer::Receiving<A>) {}
...
//> test::m::a();
//> myso::transfer::public_transfer<test::m::A>(Result(0), Input(0));
...
// gas coin by-ref
//> test::m::heat_imm<myso::coin::Coin<myso::myso::MYSO>>(Gas, Input(0));
//> test::m::play_coin(Gas);

//# programmable --sender A --inputs object(5,0)
// gas coin by-mut
//> test::m::heat_mut<myso::coin::Coin<myso::myso::MYSO>>(Gas, Input(0));
//> test::m::play_coin(Gas);
...
//> 0: test::m::heat_imm<myso::transfer::Receiving<test::m::A>>(Input(0), Input(1));
//> test::m::play_receiving(Input(0));

//# programmable --sender A --inputs receiving(4,0) object(5,0)
// receiving input by-mut
//> 0: test::m::heat_mut<myso::transfer::Receiving<test::m::A>>(Input(0), Input(1));
//> test::m::play_receiving(Input(0));

//# programmable --sender A --inputs receiving(4,0) object(5,0)
// receiving input by-val
//> 0: test::m::heat_val<myso::transfer::Receiving<test::m::A>>(Input(0), Input(1));
