...
// gas coin by-ref
//> test::m::heat_imm<myso::coin::Coin<myso::myso::MYSO>>(Gas);
//> test::m::cool(Result(0));
//> test::m::play_coin(Gas);

//# programmable --sender A
// gas coin by-mut
//> test::m::heat_mut<myso::coin::Coin<myso::myso::MYSO>>(Gas);
//> test::m::cool(Result(0));
//> test::m::play_coin(Gas)
...
//> 0: test::m::heat_imm<myso::transfer::Receiving<test::m::A>>(Input(0));
//> test::m::cool(Result(0));
//> test::m::play_receiving(Input(0));

//# programmable --sender A --inputs receiving(4,0)
// receiving input by-mut
//> 0: test::m::heat_mut<myso::transfer::Receiving<test::m::A>>(Input(0));
//> test::m::cool(Result(0));
//> test::m::play_receiving(Input(0));

//# programmable --sender A --inputs receiving(4,0)
// receiving input by-val
//> 0: test::m::heat_val<myso::transfer::Receiving<test::m::A>>(Input(0));
//> test::m::cool(NestedResult(0,1));
