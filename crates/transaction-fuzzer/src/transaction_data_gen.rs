...
pub fn gen_gas_data(sender: MySoAddress) -> impl Strategy<Value = GasData> {
    (
...
pub fn transaction_data_gen(sender: MySoAddress) -> impl Strategy<Value = TransactionData> {
...
{
    pub fn new(sender: MySoAddress) -> Self {
        Self {
            kind: None,
            sender,
            gas_data: None,
