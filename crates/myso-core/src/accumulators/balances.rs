...
use myso_types::{
    TypeTag, accumulator_root::AccumulatorValue, balance::Balance, base_types::MySoAddress,
    error::MySoResult, storage::ChildObjectResolver,
};

/// Get the balance for a given owner address (which can be a wallet or an object)
/// and currency type (e.g. 0x2::myso::MYSO)
pub fn get_balance(
    owner: MySoAddress,
