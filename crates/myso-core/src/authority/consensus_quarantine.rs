...
use myso_types::messages_consensus::AuthorityIndex;
use myso_types::{
...
impl ConsensusOutputQuarantine {
    ...
    pub(super) fn commit(&mut self, epoch_store: &AuthorityPerEpochStore) -> MySoResult {
...
impl ConsensusOutputQuarantine {
    ...
    ) -> MySoResult<Vec<Option<SequenceNumber>>> {
    ...
    ) -> MySoResult<impl IntoIterator<Item = (ObjectID, u64)>> {
