...
use myso_types::messages_checkpoint::EndOfEpochData;
use myso_types::messages_checkpoint::VerifiedCheckpoint;
use myso_types::messages_checkpoint::VerifiedCheckpointContents;
...
use myso_types::storage::BalanceIterator;
use myso_types::storage::CoinInfo;
use myso_types::storage::DynamicFieldKey;
use myso_types::storage::ObjectStore;
use myso_types::storage::OwnedObjectInfo;
use myso_types::storage::RpcIndexes;
use myso_types::storage::RpcStateReader;
use myso_types::storage::TransactionInfo;
...
impl ReadStore for RocksDbStore {
            ...
            .and_then(|contents| {
                ...
                for tx in contents.iter() {
                    if let (Some(t), Some(e)) = (
                        ...
                        transactions.push(myso_types::base_types::ExecutionData::new(
                            (*t).clone().into_inner(),
                            e,
                        ))
                    } else {
    ...
    fn get_latest_checkpoint(&self) -> myso_types::storage::error::Result<VerifiedCheckpoint> {
        self.checkpoint_store
            ...
            .expect("db error")
            .ok_or_else(|| {
                myso_types::storage::error::Error::missing("unable to get latest checkpoint")
            })
    }
...
impl ObjectStore for RocksDbStore {
    fn get_object(&self, object_id: &myso_types::base_types::ObjectID) -> Option<Object> {
        self.cache_traits.object_store.get_object(object_id)
    }

    fn get_object_by_key(
        &self,
        object_id: &myso_types::base_types::ObjectID,
        version: myso_types::base_types::VersionNumber,
    ) -> Option<Object> {
        self.cache_traits
            .object_store
...
impl WriteStore for RocksDbStore {
    ...
    ) -> Result<(), myso_types::storage::error::Error> {
    ...
    fn update_highest_synced_checkpoint(
        ...
        self.checkpoint_store
            ...
            .map_err(myso_types::storage::error::Error::custom)?;
...
impl RpcStateReader for RestReadStore {
    ...
    fn get_chain_identifier(&self) -> Result<myso_types::digests::ChainIdentifier> {
    ...
    I: Iterator<Item = Result<crate::rpc_index::EventIndexKey, TypedStoreError>>,
{
    ...
    current_checkpoint_contents: Option<myso_types::messages_checkpoint::CheckpointContents>,
...
where
    I: Iterator<Item = Result<crate::rpc_index::EventIndexKey, TypedStoreError>>,
{
    type Item = Result<(u64, u64, u32, u32, myso_types::event::Event), TypedStoreError>;
...
impl RpcIndexes for RestReadStore {
    fn get_epoch_info(&self, epoch: EpochId) -> Result<Option<myso_types::storage::EpochInfo>> {
        self.index()?
    ...
    fn get_transaction_info(
        &self,
        digest: &TransactionDigest,
    ) -> myso_types::storage::error::Result<Option<TransactionInfo>> {
        self.index()?
    ...
    ) -> myso_types::storage::error::Result<
    ...
    fn get_coin_info(
        &self,
        coin_type: &StructTag,
    ) -> myso_types::storage::error::Result<Option<CoinInfo>> {
        self.index()?
    ...
    fn get_balance(
        ...
        owner: &MySoAddress,
        coin_type: &StructTag,
    ) -> myso_types::storage::error::Result<Option<BalanceInfo>> {
        self.index()?
    ...
    fn balance_iter(
        &self,
        owner: &MySoAddress,
        cursor: Option<(MySoAddress, StructTag)>,
    ) -> myso_types::storage::error::Result<BalanceIterator<'_>> {
        let cursor_key =
    ...
    fn get_highest_indexed_checkpoint_seq_number(
        &self,
    ) -> myso_types::storage::error::Result<Option<CheckpointSequenceNumber>> {
        self.index()?
    ...
    fn authenticated_event_iter(
        ...
        Box<
            dyn Iterator<
                    Item = Result<(u64, u64, u32, u32, myso_types::event::Event), TypedStoreError>,
                > + '_,
        >,
    > {
