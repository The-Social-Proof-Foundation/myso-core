...
use crate::consensus_validator::MySoTxValidator;
...
struct AddressOverridesMap {
    ...
    map: BTreeMap<
        ...
        BTreeMap<myso_network::endpoint_manager::AddressSource, Vec<Multiaddr>>,
    >,
}
...
impl AddressOverridesMap {
    ...
    pub fn insert(
        ...
        source: myso_network::endpoint_manager::AddressSource,
...
/// Used by MySo validator to start consensus protocol for each epoch.
...
impl ConsensusAddressUpdater for ConsensusManager {
    fn update_address(
        ...
        if let Some(authority) = self.authority.load_full() {
            ...
            Err(MySoErrorKind::GenericAuthorityError {
