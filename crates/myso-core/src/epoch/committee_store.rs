...
impl CommitteeStore {
    ...
    pub fn init_genesis_committee(&self, genesis_committee: Committee) -> MySoResult {
    ...
    pub fn insert_new_committee(&self, new_committee: &Committee) -> MySoResult {
    ...
    pub fn get_committee(&self, epoch_id: &EpochId) -> MySoResult<Option<Arc<Committee>>> {
    ...
    pub fn get_latest_committee(&self) -> MySoResult<Committee> {
        Ok(self
            .tables
            .committee_map
    ...
    // todo - make use of cache or remove this method
    pub fn get_or_latest_committee(&self, epoch: Option<EpochId>) -> MySoResult<Committee> {
        Ok(match epoch {
            Some(epoch) => self
                .get_committee(&epoch)?
                .ok_or(MySoErrorKind::MissingCommitteeAtEpoch(epoch))
    ...
    fn database_is_empty(&self) -> MySoResult<bool> {
        Ok(self
            .tables
            .committee_map
            .safe_iter()
