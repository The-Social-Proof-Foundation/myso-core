...
pub struct QuorumTransactionResponse {
    pub effects: myso_types::transaction_driver_types::FinalizedEffects,

    pub events: Option<myso_types::effects::TransactionEvents>,
    // Input objects will only be populated in the happy path
    pub input_objects: Option<Vec<myso_types::object::Object>>,
    // Output objects will only be populated in the happy path
    pub output_objects: Option<Vec<myso_types::object::Object>>,
