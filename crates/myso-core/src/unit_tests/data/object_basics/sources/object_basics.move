...
module examples::object_basics {
    ...
    use myso::authenticator_state::AuthenticatorState;
    use myso::random::Random;
    use myso::dynamic_object_field as ofield;
    use myso::event;
    use myso::object::{Self, UID, ID};
    ...
    public entry fun add_field(o: &mut Object, v: Object) {
        myso::dynamic_field::add(&mut o.id, true, v);
    }

    public entry fun remove_field(o: &mut Object, ctx: &mut TxContext) {
        transfer::public_transfer(
            myso::dynamic_field::remove<bool, Object>(&mut o.id, true),
            tx_context::sender(ctx),
        );
    }
    ...
    public entry fun add_field_with_struct_name(o: &mut Object, v: Object) {
        myso::dynamic_field::add(&mut o.id, Name {name_str: std::string::utf8(b"Test Name")}, v);
    }
    ...
    public entry fun add_field_with_bytearray_name(o: &mut Object, v: Object) {
        myso::dynamic_field::add(&mut o.id,b"Test Name", v);
    }
    ...
    public entry fun add_field_with_address_name(o: &mut Object, v: Object,  ctx: &mut TxContext) {
        myso::dynamic_field::add(&mut o.id,tx_context::sender(ctx), v);
    }
