...
/// Send a simple shared object transaction to MySo and ensures the client gets back a response.
#[sim_test]
...
/// End-to-end shared transaction test for a MySo validator. It does not test the client or wallet,
/// but tests the end-to-end flow from MySo to consensus.
#[sim_test]
