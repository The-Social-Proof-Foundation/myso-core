...
pub async fn start_rosetta_test_server(client: GrpcClient) -> (RosettaClient, Vec<JoinHandle<()>>) {
    let online_server = RosettaOnlineServer::new(MySoEnv::LocalNet, client);
    let offline_server = RosettaOfflineServer::new(MySoEnv::LocalNet);
            ...
            .call(
                ...
                &ConstructionCombineRequest {
                    ...
                    signatures: vec![Signature {
                        ...
                        hex_bytes: Hex::from_bytes(MySoSignature::signature_bytes(&signature)),
                    }],
                },
            )
            .await;
