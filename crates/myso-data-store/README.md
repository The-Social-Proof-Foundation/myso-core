...
after the GraphQL schema in `crates/myso-indexer-alt-graphql/schema.graphql`.
...
```rust
use myso_data_store::{Node, stores::{DataStore, LruMemoryStore, ReadThroughStore, FileSystemStore}};
