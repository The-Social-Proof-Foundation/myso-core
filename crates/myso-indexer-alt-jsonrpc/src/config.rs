...
pub struct RpcConfig {
    ...
    pub package_resolver: myso_package_resolver::Limits,
}
...
impl PackageResolverLayer {
    pub fn finish(self) -> myso_package_resolver::Limits {
        myso_package_resolver::Limits {
...
impl Default for NodeConfig {
    fn default() -> Self {
        Self {
            header_value: "myso-indexer-alt-jsonrpc".to_string(),
