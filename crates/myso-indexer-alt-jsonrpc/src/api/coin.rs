...
use myso_indexer_alt_reader::consistent_reader::proto::Balance as ProtoBalance;
use myso_indexer_alt_reader::consistent_reader::proto::owner::OwnerKind;
use myso_json_rpc_types::Balance;
use myso_json_rpc_types::Coin;
use myso_json_rpc_types::Page as PageResponse;
use myso_json_rpc_types::MySoCoinMetadata;
use myso_open_rpc::Module;
use myso_open_rpc_macros::open_rpc;
use myso_types::MYSO_FRAMEWORK_ADDRESS;
use myso_types::base_types::ObjectID;
use myso_types::base_types::MySoAddress;
use myso_types::coin::COIN_METADATA_STRUCT_NAME;
use myso_types::coin::COIN_MODULE_NAME;
use myso_types::coin::COIN_STRUCT_NAME;
...
#[open_rpc(namespace = "mysox", tag = "Coin API")]
#[rpc(server, namespace = "mysox")]
trait CoinsApi {
    /// Return Coin objects owned by an address with a specified coin type.
    /// If no coin type is specified, MYSO coins are returned.
    #[method(name = "getCoins")]
    async fn get_coins(
        &self,
        /// the owner's MySo address
        owner: MySoAddress,
        /// optional coin type
    ...
    async fn get_coin_metadata(
        ...
        coin_type: String,
    ) -> RpcResult<Option<MySoCoinMetadata>>;
    ...
    /// If no coin type is specified, MYSO coin balance is returned.
    #[method(name = "getBalance")]
    async fn get_balance(
        &self,
        /// the owner's MySo address
        owner: MySoAddress,
        /// optional type names for the coin (e.g., 0x168da5bf1f48dafc111b0a488fa454aca95e0b5e::usdc::USDC), default to 0x2::myso::MYSO if not specified.
        coin_type: Option<String>,
    ) -> RpcResult<Balance>;
}
...
async fn coin_registry_response(
    ctx: &Context,
    coin_type: &str,
) -> Result<Option<MySoCoinMetadata>, RpcError<Error>> {
...
/// Given the inner coin type, i.e 0x2::myso::MYSO, load the CoinMetadata object.
