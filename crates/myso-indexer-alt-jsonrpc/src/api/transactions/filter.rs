...
use myso_indexer_alt_reader::tx_digests::TxDigestKey;
use myso_indexer_alt_schema::schema::tx_affected_addresses;
use myso_indexer_alt_schema::schema::tx_affected_objects;
use myso_indexer_alt_schema::schema::tx_calls;
use myso_indexer_alt_schema::schema::tx_digests;
use myso_indexer_alt_schema::transactions::StoredTxDigest;
...
pub(crate) struct MySoTransactionBlockResponseQuery {
