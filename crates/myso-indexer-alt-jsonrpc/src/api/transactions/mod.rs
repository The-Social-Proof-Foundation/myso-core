...
use crate::api::transactions::filter::MySoTransactionBlockResponseQuery;
...
#[open_rpc(namespace = "myso", tag = "Transactions API")]
...
#[open_rpc(namespace = "mysox", tag = "Query Transactions API")]
...
trait QueryTransactionsApi {
    ...
    ) -> RpcResult<Page<MySoTransactionBlockResponse, String>>;
}
