...
pub(crate) struct MySoObjectResponseQuery {
...
pub(crate) enum MySoObjectDataFilter {
...
/// [MySoObjectDataFilter] converted into fields that can be compared directly with values coming
/// from the database.
enum RawFilter {
...
/// all point to `myso::dynamic_field::Field<K, V>` objects. Returns the IDs and a cursor pointing
...
pub(crate) async fn dynamic_fields(
    ...
    by_type_indices(
        ...
        &Some(MySoObjectDataFilter::StructType(StructTag {
