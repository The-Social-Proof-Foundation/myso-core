...
use filter::MySoObjectResponseQuery;
use futures::future;
...
#[open_rpc(namespace = "myso", tag = "Objects API")]
...
#[open_rpc(namespace = "mysox", tag = "Query Objects API")]
...
trait QueryObjectsApi {
    ...
    async fn get_owned_objects(
        ...
        limit: Option<usize>,
    ) -> RpcResult<Page<MySoObjectResponse, String>>;
}
