...
use myso_types::{
    base_types::MySoAddress, digests::TransactionDigest,
...
impl Command {
    ...
    pub fn new_pay_myso() -> Self {
        Self {
            data: CommandData::PayMySo(PayMySo {}),
            ..Default::default()
        }
    }
    ...
    pub fn new_get_all_balances(addresses: Vec<MySoAddress>, chunk_size: usize) -> Self {
