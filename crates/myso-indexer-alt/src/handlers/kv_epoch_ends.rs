...
use myso_indexer_alt_framework::types::event::SystemEpochInfoEvent;
...
use myso_indexer_alt_schema::schema::kv_epoch_ends;
...
mod tests {
    ...
    use myso_indexer_alt_framework::types::test_checkpoint_data_builder::AdvanceEpochConfig;
