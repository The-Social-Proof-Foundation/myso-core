...
use myso_indexer_alt_schema::objects::StoredObjInfoDeletionReference;
use myso_indexer_alt_schema::schema::obj_info;
use myso_indexer_alt_schema::schema::obj_info_deletion_reference;
...
impl Handler for ObjInfo {
    ...
    async fn prune<'a>(
        ...
        // avoids HashAggregate operations and the enmysong materialization overhead.
        //
