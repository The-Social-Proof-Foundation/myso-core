...
use myso_indexer_alt_schema::events::StoredEvStructInst;
use myso_indexer_alt_schema::schema::ev_struct_inst;
...
mod tests {
    ...
    use myso_indexer_alt_framework::types::event::Event;
