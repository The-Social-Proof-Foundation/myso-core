...
use myso_indexer_alt_framework::pipeline::concurrent::PrunerConfig;
...
impl IndexerConfig {
    /// Generate an example configuration, mysotable for demonstrating the fields available to
    /// configure.
    pub fn example() -> Self {
    ...
    /// Generate a configuration mysotable for testing. This is the same as the example
