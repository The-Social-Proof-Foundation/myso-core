...
myso client --client.config $CONFIG publish a > output.log 2>&1 || cat output.log

echo "=== published a ==="
extract_published a/Published.toml

myso client --client.config $CONFIG publish b > output.log 2>&1 || cat output.log
...
myso client --client.config $CONFIG upgrade b > output.log 2>&1 || cat output.log

echo "=== upgraded b ==="
extract_published b/Published.toml

myso client --client.config $CONFIG upgrade a > output.log 2>&1 || cat output.log
...
myso client --client.config $CONFIG upgrade b
