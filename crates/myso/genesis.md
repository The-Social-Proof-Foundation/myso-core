...
This document lays out the step-by-step process for orchestrating a MySo Genesis Ceremony.
...
- An Ed25519 key can be created using `myso keytool generate`
