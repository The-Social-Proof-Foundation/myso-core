...
use myso_types::transaction::InputObjects;
use myso_types::transaction::ObjectReadResult;
...
pub trait SimulatorStore:
    myso_types::storage::BackingPackageStore
    + myso_types::storage::ObjectStore
    + ParentSync
    + ChildObjectResolver
{
    ...
    ) -> MySoResult<(InputObjects, ReceivingObjects)> {
