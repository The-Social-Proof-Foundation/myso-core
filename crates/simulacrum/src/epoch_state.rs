...
use myso_types::{
    ...
    myso_system_state::{
        MySoSystemState, MySoSystemStateTrait,
        epoch_start_myso_system_state::{EpochStartSystemState, EpochStartSystemStateTrait},
    },
...
impl EpochState {
    pub fn new(system_state: MySoSystemState) -> Self {
        let protocol_config =
    ...
    pub fn new_with_protocol_config(
        ...
        let committee = epoch_start_state.get_myso_committee();
    ...
    pub fn execute_transaction(
        ...
        MySoGasStatus,
        TransactionEffects,
        Result<(), myso_types::error::ExecutionError>,
    )> {
        ...
        // for signing
        let (gas_status, checked_input_objects) = myso_transaction_checks::check_transaction_input(
            &self.protocol_config,
            self.epoch_start_state.reference_gas_price(),
