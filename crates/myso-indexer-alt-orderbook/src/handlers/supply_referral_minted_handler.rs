use crate::models::orderbook_margin::margin_pool::SupplyReferralMinted;
use myso_indexer_alt_orderbook_schema::models::SupplyReferralMinted as SupplyReferralMintedModel;
