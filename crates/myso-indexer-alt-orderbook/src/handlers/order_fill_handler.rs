use crate::models::orderbook::order_info::OrderFilled;
use myso_indexer_alt_orderbook_schema::models::OrderFill;
...
define_handler! {
    ...
    map_event: |event, meta| OrderFill {
        ...
        taker_fee_is_myso: event.taker_fee_is_myso,
        maker_fee: event.maker_fee as i64,
        maker_fee_is_myso: event.maker_fee_is_myso,
