...
use crate::models::orderbook_margin::tpsl::ConditionalOrderInsufficientFunds as ConditionalOrderInsufficientFundsEvent;
use myso_indexer_alt_orderbook_schema::models::ConditionalOrderEvent;
...
define_handler! {
    ...
    map_event: |event, meta| ConditionalOrderEvent {
        ...
        pay_with_myso: event.conditional_order.pending_order.pay_with_myso,
