use crate::models::orderbook_margin::margin_pool::InterestParamsUpdated;
use myso_indexer_alt_orderbook_schema::models::InterestParamsUpdated as InterestParamsUpdatedModel;
