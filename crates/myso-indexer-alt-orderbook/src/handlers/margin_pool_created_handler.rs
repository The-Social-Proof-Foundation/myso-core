use crate::models::orderbook_margin::margin_pool::MarginPoolCreated;
use myso_indexer_alt_orderbook_schema::models::MarginPoolCreated as MarginPoolCreatedModel;
