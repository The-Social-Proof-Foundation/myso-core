use crate::models::orderbook_margin::margin_registry::MaintainerCapUpdated;
use myso_indexer_alt_orderbook_schema::models::MaintainerCapUpdated as MaintainerCapUpdatedModel;
