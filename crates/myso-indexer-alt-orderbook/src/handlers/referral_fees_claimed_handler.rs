use crate::models::orderbook_margin::protocol_fees::ReferralFeesClaimedEvent;
use myso_indexer_alt_orderbook_schema::models::ReferralFeesClaimedEvent as ReferralFeesClaimedEventModel;
