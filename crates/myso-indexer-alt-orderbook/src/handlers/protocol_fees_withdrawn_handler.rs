use crate::models::orderbook_margin::margin_pool::ProtocolFeesWithdrawn;
use myso_indexer_alt_orderbook_schema::models::ProtocolFeesWithdrawn as ProtocolFeesWithdrawnModel;
