use crate::models::orderbook_margin::protocol_fees::ProtocolFeesIncreasedEvent;
use myso_indexer_alt_orderbook_schema::models::ProtocolFeesIncreasedEvent as ProtocolFeesIncreasedEventModel;
