use crate::models::orderbook::pool::ReferralFeeEvent;
use myso_indexer_alt_orderbook_schema::models::ReferralFeeEvent as ReferralFeeEventModel;
...
define_handler! {
    ...
    map_event: |event, meta| ReferralFeeEventModel {
        ...
        myso_fee: event.myso_fee as i64,
    }
}
