use crate::models::orderbook_margin::margin_manager::MarginManagerCreatedEvent;
use myso_indexer_alt_orderbook_schema::models::MarginManagerCreated;
...
define_handler! {
    ...
    map_event: |event, meta| MarginManagerCreated {
        ...
        orderbook_pool_id: Some(event.orderbook_pool_id.to_string()),
