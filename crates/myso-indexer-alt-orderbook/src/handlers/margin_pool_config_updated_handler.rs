use crate::models::orderbook_margin::margin_pool::MarginPoolConfigUpdated;
use myso_indexer_alt_orderbook_schema::models::MarginPoolConfigUpdated as MarginPoolConfigUpdatedModel;
