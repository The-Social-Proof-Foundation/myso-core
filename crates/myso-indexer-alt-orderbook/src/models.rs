...
pub mod orderbook {
    ...
    pub mod order_info {
        ...
        pub struct OrderFilled {
            ...
            pub taker_fee: u64,
            pub taker_fee_is_myso: bool,
            pub maker_fee: u64,
            pub maker_fee_is_myso: bool,
    ...
    pub mod myso_price {
        ...
        impl MoveStruct for PriceAdded {
            const MODULE: &'static str = "myso_price";
    ...
    pub mod pool {
        ...
        #[derive(Debug, Clone, Serialize, Deserialize)]
        pub struct MysoBurned<BaseAsset, QuoteAsset> {
            pub pool_id: ObjectID,
            pub myso_burned: u64,
            #[serde(skip)]
            pub phantom_base: PhantomData<BaseAsset>,
        ...
        impl<BaseAsset, QuoteAsset> MoveStruct for MysoBurned<BaseAsset, QuoteAsset> {
            const MODULE: &'static str = "pool";
            const NAME: &'static str = "MysoBurned";
        }
...
/// Represents a MySo TypeName (package::module::Type)
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TypeName {
    pub name: String,
}

// Orderbook Margin module
pub mod orderbook_margin {
    use super::*;
    ...
    pub mod margin_manager {
        ...
        pub struct MarginManagerCreatedEvent {
            ...
            pub balance_manager_id: ObjectID,
            pub orderbook_pool_id: ObjectID,
            pub owner: Address,
            pub timestamp: u64,
        }
    ...
    pub mod margin_pool {
        ...
        #[derive(Debug, Clone, Serialize, Deserialize)]
        pub struct OrderbookPoolUpdated {
            pub margin_pool_id: ObjectID,
            pub orderbook_pool_id: ObjectID,
        ...
        impl MoveStruct for OrderbookPoolUpdated {
            const MODULE: &'static str = "margin_pool";
            const NAME: &'static str = "OrderbookPoolUpdated";
        }
    ...
    pub mod margin_registry {
        ...
        #[derive(Debug, Clone, Serialize, Deserialize)]
        pub struct OrderbookPoolRegistered {
            pub pool_id: ObjectID,
        ...
        #[derive(Debug, Clone, Serialize, Deserialize)]
        pub struct OrderbookPoolConfigUpdated {
            pub pool_id: ObjectID,
            pub config: PoolConfig,
            pub timestamp: u64,
        }
        ...
        impl MoveStruct for OrderbookPoolRegistered {
            const MODULE: &'static str = "margin_registry";
            const NAME: &'static str = "OrderbookPoolRegistered";
        }
        ...
        impl MoveStruct for OrderbookPoolConfigUpdated {
            const MODULE: &'static str = "margin_registry";
            const NAME: &'static str = "OrderbookPoolConfigUpdated";
        }
...
pub mod myso {
    pub mod myso {
        ...
        impl MoveStruct for MYSO {
            const MODULE: &'static str = "myso";
            const NAME: &'static str = "MYSO";
        }
    }
}
