...
- **Pool**: MYSO/USDC (`0xe05dafb5133bcffb8d59f4e12465dc0e9faeaa05e3e342a08fe135800e3e4407`)
...
```bash
curl -o <checkpoint>.chk "https://checkpoints.mainnet.mysocial.network/<checkpoint>.chk"
```
