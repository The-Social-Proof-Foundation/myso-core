...
-- Indexes for orderbook_pool_updated table
CREATE INDEX IF NOT EXISTS idx_orderbook_pool_updated_checkpoint_timestamp_ms
    ON orderbook_pool_updated (checkpoint_timestamp_ms);

CREATE INDEX IF NOT EXISTS idx_orderbook_pool_updated_margin_pool_id
    ON orderbook_pool_updated (margin_pool_id);

CREATE INDEX IF NOT EXISTS idx_orderbook_pool_updated_orderbook_pool_id
    ON orderbook_pool_updated (orderbook_pool_id);
...
-- Indexes for orderbook_pool_registered table
CREATE INDEX IF NOT EXISTS idx_orderbook_pool_registered_checkpoint_timestamp_ms
    ON orderbook_pool_registered (checkpoint_timestamp_ms);

CREATE INDEX IF NOT EXISTS idx_orderbook_pool_registered_pool_id
    ON orderbook_pool_registered (pool_id);

-- Indexes for orderbook_pool_updated_registry table
CREATE INDEX IF NOT EXISTS idx_orderbook_pool_updated_registry_checkpoint_timestamp_ms
    ON orderbook_pool_updated_registry (checkpoint_timestamp_ms);

CREATE INDEX IF NOT EXISTS idx_orderbook_pool_updated_registry_pool_id
    ON orderbook_pool_updated_registry (pool_id);

-- Indexes for orderbook_pool_config_updated table
CREATE INDEX IF NOT EXISTS idx_orderbook_pool_config_updated_checkpoint_timestamp_ms
    ON orderbook_pool_config_updated (checkpoint_timestamp_ms);

CREATE INDEX IF NOT EXISTS idx_orderbook_pool_config_updated_pool_id
    ON orderbook_pool_config_updated (pool_id);
