...
-- Drop indexes for orderbook_pool_updated table
DROP INDEX IF EXISTS idx_orderbook_pool_updated_checkpoint_timestamp_ms;
DROP INDEX IF EXISTS idx_orderbook_pool_updated_margin_pool_id;
DROP INDEX IF EXISTS idx_orderbook_pool_updated_orderbook_pool_id;
...
-- Drop indexes for orderbook_pool_registered table
DROP INDEX IF EXISTS idx_orderbook_pool_registered_checkpoint_timestamp_ms;
DROP INDEX IF EXISTS idx_orderbook_pool_registered_pool_id;

-- Drop indexes for orderbook_pool_updated_registry table
DROP INDEX IF EXISTS idx_orderbook_pool_updated_registry_checkpoint_timestamp_ms;
DROP INDEX IF EXISTS idx_orderbook_pool_updated_registry_pool_id;

-- Drop indexes for orderbook_pool_config_updated table
DROP INDEX IF EXISTS idx_orderbook_pool_config_updated_checkpoint_timestamp_ms;
DROP INDEX IF EXISTS idx_orderbook_pool_config_updated_pool_id;
