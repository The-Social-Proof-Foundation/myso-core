...
CREATE TABLE orderbook_pool_updated (
    event_digest                TEXT        PRIMARY KEY,
    digest                      TEXT        NOT NULL,
    sender                      TEXT        NOT NULL,
    checkpoint                  BIGINT      NOT NULL,
    ...
    package                     TEXT        NOT NULL,
    margin_pool_id              TEXT        NOT NULL,
    orderbook_pool_id            TEXT        NOT NULL,
...
CREATE TABLE orderbook_pool_registered (
    event_digest                TEXT        PRIMARY KEY,
    digest                      TEXT        NOT NULL,
    sender                      TEXT        NOT NULL,
    checkpoint                  BIGINT      NOT NULL,
...
CREATE TABLE orderbook_pool_updated_registry (
    event_digest                TEXT        PRIMARY KEY,
    digest                      TEXT        NOT NULL,
    sender                      TEXT        NOT NULL,
    checkpoint                  BIGINT      NOT NULL,
...
CREATE TABLE orderbook_pool_config_updated (
    event_digest                TEXT        PRIMARY KEY,
    digest                      TEXT        NOT NULL,
    sender                      TEXT        NOT NULL,
    checkpoint                  BIGINT      NOT NULL,
