...
diesel::table! {
    orderbook_pool_config_updated (event_digest) {
        event_digest -> Text,
        digest -> Text,
        sender -> Text,
        checkpoint -> Int8,
...
diesel::table! {
    orderbook_pool_registered (event_digest) {
        event_digest -> Text,
        digest -> Text,
        sender -> Text,
        checkpoint -> Int8,
...
diesel::table! {
    orderbook_pool_updated (event_digest) {
        event_digest -> Text,
        digest -> Text,
        sender -> Text,
        checkpoint -> Int8,
...
diesel::table! {
    orderbook_pool_updated_registry (event_digest) {
        event_digest -> Text,
        digest -> Text,
        sender -> Text,
        checkpoint -> Int8,
...
diesel::table! {
    margin_manager_created (event_digest) {
        ...
        owner -> Text,
        onchain_timestamp -> Int8,
        orderbook_pool_id -> Nullable<Text>,
    }
}
