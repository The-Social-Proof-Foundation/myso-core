...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug, FieldCount)]
#[diesel(table_name = myso_burned, primary_key(event_digest))]
pub struct MysoBurned {
    pub event_digest: String,
    pub digest: String,
    pub sender: String,
    pub checkpoint: i64,
...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug, FieldCount)]
#[diesel(table_name = myso_error_transactions, primary_key(txn_digest))]
...
pub struct MarginManagerCreated {
    ...
    pub balance_manager_id: String,
    pub orderbook_pool_id: Option<String>,
    pub owner: String,
    pub onchain_timestamp: i64,
}
...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug, FieldCount, Serialize)]
#[diesel(table_name = orderbook_pool_updated, primary_key(event_digest))]
...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug, FieldCount, Serialize)]
#[diesel(table_name = orderbook_pool_registered, primary_key(event_digest))]
...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug, FieldCount, Serialize)]
#[diesel(table_name = orderbook_pool_updated_registry, primary_key(event_digest))]
pub struct OrderbookPoolUpdatedRegistry {
    pub event_digest: String,
    pub digest: String,
    pub sender: String,
    pub checkpoint: i64,
...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug, FieldCount, Serialize)]
#[diesel(table_name = orderbook_pool_config_updated, primary_key(event_digest))]
