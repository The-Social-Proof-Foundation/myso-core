...
pub struct WatchdogMetrics {
    ...
    pub myso_bridge_paused: IntGauge,
}
    ...
    pub fn new(registry: &Registry) -> Self {
        Self {
            ...
            total_supplies: register_int_gauge_vec_with_registry!(
                ...
                "Current total supplies of coins on MySo based on Treasury Cap",
                &["token_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            myso_bridge_paused: register_int_gauge_with_registry!(
                "bridge_myso_bridge_paused",
                "Whether the myso bridge is paused",
                registry,
            )
            .unwrap(),
        }
