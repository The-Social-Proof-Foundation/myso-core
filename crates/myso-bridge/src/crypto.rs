...
mod tests {
    ...
    use crate::test_utils::{get_test_authority_and_key, get_test_myso_to_eth_bridge_action};
    ...
    fn test_sign_and_verify_bridge_event_basic() -> anyhow::Result<()> {
        ...
        let mismatched_action: BridgeAction =
            get_test_myso_to_eth_bridge_action(None, Some(2), Some(3), Some(4), None, None, None);
        ...
        let action2: BridgeAction =
            get_test_myso_to_eth_bridge_action(None, Some(3), Some(5), Some(77), None, None, None);
    ...
    fn test_bridge_sig_verification_regression_test() {
        ...
        let action = BridgeAction::MySoToEthBridgeAction(MySoToEthBridgeAction {
            myso_tx_digest: TransactionDigest::random(),
            myso_tx_event_index: 0,
            myso_bridge_event: EmittedMySoToEthTokenBridgeV1 {
                nonce: 1,
                myso_chain_id: BridgeChainId::MySoTestnet,
                myso_address: MySoAddress::from_str(
                ...
                amount_myso_adjusted: 100000u64,
            },
        });
