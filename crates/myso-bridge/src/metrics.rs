...
pub struct BridgeMetrics {
    pub(crate) err_build_myso_transaction: IntCounter,
    pub(crate) err_signature_aggregation: IntCounter,
    pub(crate) err_signature_aggregation_too_many_failures: IntCounter,
    pub(crate) err_myso_transaction_submission: IntCounter,
    pub(crate) err_myso_transaction_submission_too_many_failures: IntCounter,
    pub(crate) err_myso_transaction_execution: IntCounter,
    ...
    pub(crate) last_synced_myso_checkpoints: IntGaugeVec,
    pub(crate) last_finalized_eth_block: IntGauge,
    pub(crate) last_synced_eth_blocks: IntGaugeVec,

    pub(crate) myso_watcher_received_events: IntCounter,
    pub(crate) myso_watcher_received_actions: IntCounter,
    ...
    pub(crate) myso_rpc_errors: IntCounterVec,
    ...
    pub(crate) myso_eth_token_transfer_approved: IntCounter,
    pub(crate) myso_eth_token_transfer_claimed: IntCounter,
    pub(crate) eth_myso_token_transfer_approved: IntCounter,
    pub(crate) eth_myso_token_transfer_claimed: IntCounter,
}

impl BridgeMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            err_build_myso_transaction: register_int_counter_with_registry!(
                "bridge_err_build_myso_transaction",
                "Total number of errors of building myso transactions",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            err_myso_transaction_submission: register_int_counter_with_registry!(
                "bridge_err_myso_transaction_submission",
                "Total number of errors of submitting myso transactions",
                registry,
            )
            .unwrap(),
            err_myso_transaction_submission_too_many_failures: register_int_counter_with_registry!(
                "bridge_err_myso_transaction_submission_too_many_failures",
                "Total number of continuous failures to submitting myso transactions",
                registry,
            )
            .unwrap(),
            err_myso_transaction_execution: register_int_counter_with_registry!(
                "bridge_err_myso_transaction_execution",
                "Total number of failures of myso transaction execution",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            myso_watcher_received_events: register_int_counter_with_registry!(
                "bridge_myso_watcher_received_events",
                "Total number of received events in myso watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            myso_watcher_received_actions: register_int_counter_with_registry!(
                "bridge_myso_watcher_received_actions",
                "Total number of received actions in myso watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            last_synced_myso_checkpoints: register_int_gauge_vec_with_registry!(
                "bridge_last_synced_myso_checkpoints",
                "The latest myso checkpoints synced for each module",
                &["module_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            myso_rpc_errors: register_int_counter_vec_with_registry!(
                "bridge_myso_rpc_errors",
                "Total number of errors from myso RPC, by RPC method",
                &["method"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            myso_eth_token_transfer_approved: register_int_counter_with_registry!(
                "bridge_myso_eth_token_transfer_approved",
                "Total number of approved myso to eth token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            myso_eth_token_transfer_claimed: register_int_counter_with_registry!(
                "bridge_myso_eth_token_transfer_claimed",
                "Total number of claimed myso to eth token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            eth_myso_token_transfer_approved: register_int_counter_with_registry!(
                "bridge_eth_myso_token_transfer_approved",
                "Total number of approved eth to myso token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            eth_myso_token_transfer_claimed: register_int_counter_with_registry!(
                "bridge_eth_myso_token_transfer_claimed",
                "Total number of claimed eth to myso token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
