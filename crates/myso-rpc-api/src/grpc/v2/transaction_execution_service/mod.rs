...
use myso_rpc::proto::mys::rpc::v2::ExecuteTransactionRequest;
use myso_rpc::proto::mys::rpc::v2::ExecuteTransactionResponse;
...
use myso_rpc::proto::mys::rpc::v2::UserSignature;
use myso_rpc::proto::mys::rpc::v2::transaction_execution_service_server::TransactionExecutionService;
...
pub async fn execute_transaction(
    ...
    let transaction = request
        ...
        .pipe(myso_sdk_types::Transaction::try_from)
        .map_err(|e| {
    ...
    let signatures = request
        ...
        .enumerate()
        .map(|(i, signature)| {
            myso_sdk_types::UserSignature::try_from(signature).map_err(|e| {
    ...
    let signed_transaction = myso_sdk_types::SignedTransaction {
    ...
    let request = myso_types::transaction_driver_types::ExecuteTransactionRequestV3 {
    ...
    let myso_types::transaction_driver_types::ExecuteTransactionResponseV3 {
        effects:
            myso_types::transaction_driver_types::FinalizedEffects {
                effects,
                finality_info: _,
            },
        events,
    ...
    let executed_transaction = {
        ...
        let objects = {
            let mut objects = myso_types::full_checkpoint_content::ObjectSet::default();
