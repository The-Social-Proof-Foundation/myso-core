...
pub mod event_service_server {
    ...
    pub const SERVICE_NAME: &str = "myso.rpc.alpha.EventService";
...
pub mod proof_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/myso.rpc.alpha.ProofService/GetObjectInclusionProof",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "myso.rpc.alpha.ProofService",
...
pub mod proof_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "myso.rpc.alpha.ProofService";
