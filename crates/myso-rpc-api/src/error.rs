...
use myso_types::error::ErrorCategory;
use tonic::Code;
...
impl From<myso_types::storage::error::Error> for RpcError {
    fn from(value: myso_types::storage::error::Error) -> Self {
        use myso_types::storage::error::Kind;
...
impl From<myso_types::myso_sdk_types_conversions::SdkTypeConversionError> for RpcError {
    fn from(value: myso_types::myso_sdk_types_conversions::SdkTypeConversionError) -> Self {
        Self {
            code: Code::Internal,
            message: Some(value.to_string()),
            details: None,
...
impl From<myso_types::transaction_driver_types::TransactionSubmissionError> for RpcError {
    fn from(error: myso_types::transaction_driver_types::TransactionSubmissionError) -> Self {
            ...
            InvalidUserSignature(err) => {
                let message = {
                    let err = match err.as_inner() {
                        MySoErrorKind::UserInputError { error } => error.to_string(),
                        _ => err.to_string(),
                    };
                ...
                let new_errors: Vec<String> = errors
                    ...
                    .filter_map(|(err, _, _)| {
                        match err.as_inner() {
                            ...
                            MySoErrorKind::UserInputError { error } => Some(error.to_string()),
                            _ => {
...
pub struct ObjectNotFoundError {
    object_id: myso_sdk_types::Address,
    version: Option<myso_sdk_types::Version>,
}

impl ObjectNotFoundError {
    pub fn new(object_id: myso_sdk_types::Address) -> Self {
        Self {
            object_id,
            version: None,
        }
    ...
    pub fn new_with_version(
        object_id: myso_sdk_types::Address,
        version: myso_sdk_types::Version,
    ) -> Self {
        Self {
            object_id,
...
impl CheckpointNotFoundError {
    ...
    pub fn digest(digest: myso_sdk_types::Digest) -> Self {
        Self {
