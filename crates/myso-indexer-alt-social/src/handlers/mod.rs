...
use myso_indexer_alt_social_schema::models::{
    ...
    NewOrgRoleAssignment, NewOrganizationEvent, NewPaidMessageEscrow, NewPlatform,
    ...
    NewProfileConfig, NewProfileEvent, NewProfileSubscription, NewProfileSubscriptionService,
    NewProposal, NewReaction, NewReport, NewRepost, NewRewardDistribution, NewSocialGraphEvent,
    NewSocialGraphRelationship, NewSocialProofTokensEvent, NewSpotBet, NewSpotBetWithdrawal,
    ...
    NewSptReservationPool, NewSptTransaction, NewSubAgentEvent, NewSubscriptionConfig,
