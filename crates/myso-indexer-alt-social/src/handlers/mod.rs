...
use myso_indexer_alt_social_schema::models::{
    ...
    NewAiCreditEvent, NewAiCreditSpendApproval, NewAiSpendReservation, NewAnonymousVote, NewAuditLog, NewBlockedEvent,
    ...
    NewInsuranceVaultTransaction, NewMemoryAccount, NewMemoryConfig, NewMessageDigest, NewMessagingAgentGroup,
    ...
    NewPlatformTreasuryWithdrawal, NewPocAnalysisResult, NewPocBadge, NewPocConfiguration,
