...
use myso_types::object::{MoveObject, Object};
...
pub struct Registry {
    ...
    reverse_registry: Table<MySoAddress, Domain>,
}
...
pub struct NameRecord {
    ...
    pub target_address: Option<MySoAddress>,
    /// Additional data which may be stored in a record
    pub data: VecMap<String, String>,
}

/// A MySonsRegistration object to manage an SLD
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct MySonsRegistration {
    pub id: UID,
    pub domain: Domain,
...
pub struct NameServiceConfig {
    pub package_address: MySoAddress,
    pub registry_id: ObjectID,
    pub reverse_registry_id: ObjectID,
}

/// Rust version of the Move myso::table::Table type.
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
...
impl Domain {
    pub fn type_(package_address: MySoAddress) -> StructTag {
        StructTag {
...
impl NameServiceConfig {
    ...
    pub fn record_field_id(&self, domain: &Domain) -> ObjectID {
        ...
        myso_types::dynamic_field::derive_dynamic_field_id(
            self.registry_id,
    ...
    pub fn mainnet() -> Self {
        ...
        let package_address = MySoAddress::from_str(MAINNET_NS_PACKAGE_ADDRESS).unwrap();
    ...
    pub fn testnet() -> Self {
        ...
        let package_address = MySoAddress::from_str(TESTNET_NS_PACKAGE_ADDRESS).unwrap();
...
mod tests {
    ...
    fn test_expirations() {
        ...
        let mut name = NameRecord {
            nft_id: myso_types::id::ID::new(ObjectID::random()),
            data: VecMap { contents: vec![] },
            target_address: Some(MySoAddress::random_for_testing_only()),
