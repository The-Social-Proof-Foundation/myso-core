...
pub type Gas = (ObjectRef, MySoAddress, Arc<AccountKeyPair>);
pub type MultiGas = (Vec<ObjectRef>, MySoAddress, Arc<AccountKeyPair>);
...
pub struct GasCoinConfig {
    // amount of MYSO to transfer to this gas coin
    pub amount: u64,
