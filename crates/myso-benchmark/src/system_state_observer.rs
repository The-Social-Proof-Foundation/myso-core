...
impl SystemStateObserver {
    ...
    pub fn new_from_test_cluster(test_cluster: &TestCluster) -> Self {
        ...
        let convert_system_state = move |system_state: MySoSystemState| -> SystemState {
            SystemState {
        ...
        let initial_system_state = convert_system_state(test_cluster.get_myso_system_state());
