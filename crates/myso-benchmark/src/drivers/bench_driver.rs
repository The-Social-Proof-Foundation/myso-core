...
use myso_types::transaction::{Transaction, TransactionDataAPI};
    ...
    fn new(registry: &Registry) -> Self {
        BenchMetrics {
            ...
            num_submitted: register_int_counter_vec_with_registry!(
                "num_submitted",
                "Total number of transaction submitted to myso",
                &["workload", "client_type"],
                registry,
            )
            .unwrap(),
                                ...
                                let effects = details.map(|d| {
                                    ...
                                    ExecutionEffects::FinalizedTransactionEffects(
                                        myso_types::transaction_driver_types::FinalizedEffects {
                                            effects: d.effects,
                                            finality_info: myso_types::transaction_driver_types::EffectsFinalityInfo::QuorumExecuted(epoch),
                                        },
