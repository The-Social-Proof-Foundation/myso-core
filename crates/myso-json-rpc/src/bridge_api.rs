...
use myso_json_rpc_api::{BridgeReadApiOpenRpc, BridgeReadApiServer, JsonRpcMetrics};
use myso_open_rpc::Module;
use myso_types::bridge::{BridgeSummary, BridgeTrait, get_bridge_obj_initial_shared_version};
...
impl MySoRpcModule for BridgeReadApi {
