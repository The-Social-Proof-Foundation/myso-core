...
impl MoveUtilsInternalTrait for MoveUtilsInternal {
    ...
    async fn get_move_module(
        ...
        Ok(match normalized.remove(&module_name) {
            ...
            None => Err(MySoRpcInputError::GenericNotFound(format!(
        ...
        match object_read {
            ObjectRead::Exists(_obj_ref, object, _layout) => {
                match object.into_inner().data {
                    ...
                    _ => Err(MySoRpcInputError::GenericInvalid(format!(
                        "Object is not a package with ID {}",
                        package
                    )))?,
                }
            }
            _ => Err(MySoRpcInputError::GenericNotFound(format!(
...
impl MySoRpcModule for MoveUtils {
    ...
    async fn get_normalized_move_modules_by_package(
        ...
        with_tracing!(async move {
            ...
            Ok(modules
                ...
                .collect::<BTreeMap<String, MySoMoveNormalizedModule>>())
        })
    }
    ...
    async fn get_normalized_move_struct(
        ...
        with_tracing!(async move {
            ...
            let identifier = Identifier::new(struct_name.as_str())
                .map_err(|e| MySoRpcInputError::GenericInvalid(format!("{e}")))?;
...
mod tests {
    ...
    mod get_normalized_move_module_tests {
        ...
        async fn test_success_response() {
            ...
            let expected_module: MySoMoveNormalizedModule = normalized_module.into();
        ...
        async fn test_no_module_found() {
            ...
            let expected_error =
                Error::MySoRpcInputError(MySoRpcInputError::GenericNotFound(error_string.clone()));
            mock_internal
                .expect_get_move_module()
