...
use myso_types::balance_change::derive_balance_changes;
use tokio::sync::RwLock;

use myso_json_rpc_types::BalanceChange;
...
use myso_types::transaction::InputObjectKind;
    ...
    Ok(
        derive_balance_changes(effects, &input_coins, &mutated_coins)
            ...
            .map(|change| BalanceChange {
                owner: myso_types::object::Owner::AddressOwner(change.address),
