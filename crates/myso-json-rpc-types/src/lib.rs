...
pub use myso_checkpoint::*;
pub use myso_coin::*;
pub use myso_event::*;
pub use myso_extended::*;
pub use myso_governance::*;
pub use myso_move::*;
pub use myso_object::*;
pub use myso_protocol::*;
pub use myso_transaction::*;
...
pub struct DynamicFieldInfo {
    pub name: myso_types::dynamic_field::DynamicFieldName,
    #[serde(flatten)]
    pub bcs_name: BcsName,
    pub type_: myso_types::dynamic_field::DynamicFieldType,
    pub object_type: String,
    pub object_id: ObjectID,
    pub version: myso_types::base_types::SequenceNumber,
    pub digest: myso_types::digests::ObjectDigest,
}

impl From<myso_types::dynamic_field::DynamicFieldInfo> for DynamicFieldInfo {
    fn from(
        myso_types::dynamic_field::DynamicFieldInfo {
            name,
            bcs_name,
            type_,
            object_type,
