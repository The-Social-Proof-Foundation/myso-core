...
use myso_types::event::{Event, EventEnvelope, EventID};
...
pub type EventPage = Page<MySoEvent, EventID>;

#[serde_as]
#[derive(Eq, PartialEq, Clone, Debug, Serialize, Deserialize, JsonSchema)]
#[serde(rename = "Event", rename_all = "camelCase")]
pub struct MySoEvent {
...
impl From<EventEnvelope> for MySoEvent {
...
impl From<MySoEvent> for Event {
    fn from(val: MySoEvent) -> Self {
        Event {
...
impl Filter<MySoEvent> for EventFilter {
    fn matches(&self, item: &MySoEvent) -> bool {
