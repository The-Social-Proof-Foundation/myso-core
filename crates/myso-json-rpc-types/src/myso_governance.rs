...
impl From<Committee> for MySoCommittee {
...
pub struct DelegatedStake {
    /// Validator's Address.
    pub validator_address: MySoAddress,
...
#[serde(rename_all = "camelCase")]
pub struct Stake {
    /// ID of the StakedMySo receipt object.
    pub staked_myso_id: ObjectID,
    #[schemars(with = "BigInt<u64>")]
    #[serde_as(as = "BigInt<u64>")]
