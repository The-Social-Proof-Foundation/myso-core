...
The Orderbook Server is a Rust application that provides a RESTful API for the Orderbook project. It allows users to interact with the Orderbook database and retrieve information about Orderbook events.
...
```json
{
  ...
  "max_lag_pipeline": "orderbook_indexer",
  "pipelines": [
    {
      "pipeline": "orderbook_indexer",
