    ...
    pub(crate) fn new(registry: &Registry) -> Arc<Self> {
        Arc::new(Self {
            ...
            request_latency: register_histogram_vec_with_registry!(
                "orderbook_api_request_latency",
                "Time taken to respond to Orderbook API requests, by method",
                &["method"],
                LATENCY_SEC_BUCKETS.to_vec(),
                registry
            )
            ...
            requests_received: register_int_counter_vec_with_registry!(
                "orderbook_api_requests_received",
                "Number of requests initiated for each Orderbook API method",
                &["method"],
                registry
            )
                .unwrap(),
            ...
            requests_succeeded: register_int_counter_vec_with_registry!(
                "orderbook_api_requests_succeeded",
                "Number of requests that completed successfully for each Orderbook API method",
                &["method"],
                registry
            )
                .unwrap(),
            ...
            requests_failed: register_int_counter_vec_with_registry!(
                "orderbook_api_requests_failed",
                "Number of requests that completed with an error for each Orderbook API method, by error code",
                &["method", "code"],
                registry
            )
                .unwrap(),
