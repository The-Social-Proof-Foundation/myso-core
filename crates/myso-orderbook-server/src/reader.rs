...
impl Reader {
    ...
    pub async fn get_pools(&self) -> Result<Vec<Pools>, OrderbookError> {
        Ok(self
    ...
    pub async fn get_historical_volume(
        ...
        pool_ids: &Vec<String>,
        volume_in_base: bool,
    ) -> Result<Vec<(String, i64)>, OrderbookError> {
    ...
    pub async fn get_order_fill_summary(
        ...
        volume_in_base: bool,
    ) -> Result<Vec<OrderFillSummary>, OrderbookError> {
        let column_to_query = if volume_in_base {
            sql::<diesel::sql_types::BigInt>("base_quantity")
        } else {
            sql::<diesel::sql_types::BigInt>("quote_quantity")
    ...
    pub async fn get_pool_decimals(
        &self,
        pool_name: &str,
    ) -> Result<(String, i16, i16), OrderbookError> {
        ...
        self.first(query)
            .await
            .map_err(|_| OrderbookError::not_found(format!("Pool '{}'", pool_name)))
    }
    ...
    > {
        ...
        let res = query
            ...
            .select((
                ...
                schema::order_fills::maker_balance_manager_id,
                schema::order_fills::taker_balance_manager_id,
                schema::order_fills::taker_fee_is_myso,
                schema::order_fills::maker_fee_is_myso,
            ...
            .await
            .map_err(|_| {
                OrderbookError::not_found(format!(
    ...
    pub async fn get_order_updates(
    ...
    ) -> Result<Vec<(String, i64, i64, i64, i64, i64, bool, String, String)>, OrderbookError> {
        let mut connection = self.db.connect().await?;
        ...
        let res = query
            ...
            .await
            .map_err(|_| OrderbookError::database("Error fetching trade details"));
    ...
    pub async fn get_orders_status(
    ...
    ) -> Result<Vec<OrderStatus>, OrderbookError> {
        let mut connection = self.db.connect().await?;
        let _guard = self.metrics.db_latency.start_timer();
        ...
        .await
        .map_err(|e| OrderbookError::database(format!("Error fetching order status: {}", e)));
    ...
    pub async fn get_ohclv(
        ...
        end_time: Option<i64>,
        limit: Option<i32>,
    ) -> Result<Vec<(i64, f64, f64, f64, f64, f64)>, OrderbookError> {
        let mut connection = self.db.connect().await?;
        ...
        .await
        .map_err(|e| OrderbookError::database(format!("Error fetching OHCLV data: {}", e)))
        .map(|rows| {
            rows.into_iter()
                .map(|row| {
                    (
    ...
    ) -> Result<Vec<MarginManagerCreated>, OrderbookError> {
    ...
    ) -> Result<Vec<LoanBorrowed>, OrderbookError> {
    ...
    pub async fn get_loan_repaid(
        ...
        margin_manager_id_filter: String,
        margin_pool_id_filter: String,
    ) -> Result<Vec<LoanRepaid>, OrderbookError> {
    ...
    pub async fn get_liquidation(
        ...
        margin_manager_id_filter: String,
        margin_pool_id_filter: String,
    ) -> Result<Vec<Liquidation>, OrderbookError> {
    ...
    ) -> Result<Vec<AssetSupplied>, OrderbookError> {
    ...
    pub async fn get_asset_withdrawn(
        ...
        margin_pool_id_filter: String,
        supplier_filter: String,
    ) -> Result<Vec<AssetWithdrawn>, OrderbookError> {
    ...
    pub async fn get_margin_pool_created(
        &self,
        margin_pool_id_filter: String,
    ) -> Result<Vec<MarginPoolCreated>, OrderbookError> {
    ...
    pub async fn get_orderbook_pool_updated(
        &self,
        start_time: i64,
        end_time: i64,
        limit: i64,
        margin_pool_id_filter: String,
        orderbook_pool_id_filter: String,
    ) -> Result<Vec<OrderbookPoolUpdated>, OrderbookError> {
        let query = schema::orderbook_pool_updated::table
            .select(OrderbookPoolUpdated::as_select())
            .filter(
                schema::orderbook_pool_updated::checkpoint_timestamp_ms
                    .between(start_time, end_time),
            )
            .filter(
                schema::orderbook_pool_updated::margin_pool_id
                    .like(to_pattern(&margin_pool_id_filter)),
            )
            .filter(
                schema::orderbook_pool_updated::orderbook_pool_id
                    .like(to_pattern(&orderbook_pool_id_filter)),
            )
            .order_by(schema::orderbook_pool_updated::checkpoint_timestamp_ms.desc())
            .limit(limit);
    ...
    pub async fn get_interest_params_updated(
        ...
        limit: i64,
        margin_pool_id_filter: String,
    ) -> Result<Vec<InterestParamsUpdated>, OrderbookError> {
    ...
    pub async fn get_margin_pool_config_updated(
        ...
        limit: i64,
        margin_pool_id_filter: String,
    ) -> Result<Vec<MarginPoolConfigUpdated>, OrderbookError> {
    ...
    ) -> Result<Vec<MaintainerCapUpdated>, OrderbookError> {
    ...
    pub async fn get_maintainer_fees_withdrawn(
        ...
        limit: i64,
        margin_pool_id_filter: String,
    ) -> Result<Vec<MaintainerFeesWithdrawn>, OrderbookError> {
    ...
    pub async fn get_protocol_fees_withdrawn(
        ...
        limit: i64,
        margin_pool_id_filter: String,
    ) -> Result<Vec<ProtocolFeesWithdrawn>, OrderbookError> {
    ...
    ) -> Result<Vec<SupplierCapMinted>, OrderbookError> {
    ...
    pub async fn get_supply_referral_minted(
        ...
        margin_pool_id_filter: String,
        owner_filter: String,
    ) -> Result<Vec<SupplyReferralMinted>, OrderbookError> {
    ...
    ) -> Result<Vec<PauseCapUpdated>, OrderbookError> {
    ...
    pub async fn get_protocol_fees_increased(
        ...
        limit: i64,
        margin_pool_id_filter: String,
    ) -> Result<Vec<ProtocolFeesIncreasedEvent>, OrderbookError> {
    ...
    pub async fn get_referral_fees_claimed(
        ...
        owner_filter: String,
    ) -> Result<Vec<ReferralFeesClaimedEvent>, OrderbookError> {
    ...
    pub async fn get_referral_fee_events(
        ...
        referral_id_filter: String,
    ) -> Result<Vec<ReferralFeeEvent>, OrderbookError> {
    ...
    pub async fn get_orderbook_pool_registered(
        &self,
        start_time: i64,
        end_time: i64,
        limit: i64,
        pool_id_filter: String,
    ) -> Result<Vec<OrderbookPoolRegistered>, OrderbookError> {
        let query = schema::orderbook_pool_registered::table
            .select(OrderbookPoolRegistered::as_select())
            .filter(
                schema::orderbook_pool_registered::checkpoint_timestamp_ms
                    .between(start_time, end_time),
            )
            .filter(schema::orderbook_pool_registered::pool_id.like(to_pattern(&pool_id_filter)))
            .order_by(schema::orderbook_pool_registered::checkpoint_timestamp_ms.desc())
            .limit(limit);

        Ok(self.results(query).await?)
    }

    pub async fn get_orderbook_pool_updated_registry(
        &self,
        start_time: i64,
        end_time: i64,
        limit: i64,
        pool_id_filter: String,
    ) -> Result<Vec<OrderbookPoolUpdatedRegistry>, OrderbookError> {
        let query = schema::orderbook_pool_updated_registry::table
            .select(OrderbookPoolUpdatedRegistry::as_select())
            .filter(
                schema::orderbook_pool_updated_registry::checkpoint_timestamp_ms
                    .between(start_time, end_time),
            )
            .filter(
                schema::orderbook_pool_updated_registry::pool_id.like(to_pattern(&pool_id_filter)),
            )
            .order_by(schema::orderbook_pool_updated_registry::checkpoint_timestamp_ms.desc())
            .limit(limit);

        Ok(self.results(query).await?)
    }

    pub async fn get_orderbook_pool_config_updated(
        &self,
        start_time: i64,
        end_time: i64,
        limit: i64,
        pool_id_filter: String,
    ) -> Result<Vec<OrderbookPoolConfigUpdated>, OrderbookError> {
        let query = schema::orderbook_pool_config_updated::table
            .select(OrderbookPoolConfigUpdated::as_select())
            .filter(
    ...
    pub async fn get_margin_managers_info(
        ...
        Vec<(
            ...
            Option<String>, // orderbook_pool_id
    ...
    > {
        ...
        let query = diesel::sql_query(
            ...
            WITH managers_with_pools AS (
                ...
                LEFT JOIN pools p ON mmc.orderbook_pool_id = p.pool_id
        ...
        struct ManagerInfo {
            ...
            orderbook_pool_id: Option<String>,
            #[diesel(sql_type = diesel::sql_types::Nullable<diesel::sql_types::Text>)]
        ...
        let res = query
            ...
            .map_err(|_| OrderbookError::database("Error fetching margin managers info"));
    ...
    pub async fn get_margin_manager_states(
        ...
        orderbook_pool_id_filter: Option<String>,
        ...
        if let Some(pool_id) = orderbook_pool_id_filter {
            query = query.filter(orderbook_pool_id.eq(pool_id));
        }
        ...
        res.map_err(|_| OrderbookError::database("Error fetching margin manager states"))
    }

    pub async fn get_watermarks(&self) -> Result<Vec<(String, i64, i64, i64)>, OrderbookError> {
        let mut connection = self.db.connect().await?;
        let _guard = self.metrics.db_latency.start_timer();
        ...
        let res = schema::watermarks::table
            ...
            .await
            .map_err(|_| OrderbookError::database("Error fetching watermarks"));
    ...
    pub async fn get_deposited_assets_by_balance_managers(
    ...
    ) -> Result<Vec<(String, String)>, OrderbookError> {
        let mut connection = self.db.connect().await?;
        let _guard = self.metrics.db_latency.start_timer();
        ...
        let res = schema::balances::table
            ...
            .await
            .map_err(|_| OrderbookError::database("Error fetching deposited assets"));
    ...
    pub async fn get_net_deposits_from_view(
        ...
        asset_ids: &[String],
        timestamp_ms: i64,
    ) -> Result<std::collections::HashMap<String, i64>, OrderbookError> {
        let mut connection = self.db.connect().await?;
        let _guard = self.metrics.db_latency.start_timer();
        ...
        .map_err(|e| OrderbookError::database(format!("Error fetching net deposits: {}", e)))
    }
    ...
    pub async fn get_collateral_events(
    ...
    ) -> Result<Vec<CollateralEvent>, OrderbookError> {
        let mut connection = self.db.connect().await?;
        let _guard = self.metrics.db_latency.start_timer();
        ...
        res.map_err(|_| OrderbookError::database("Error fetching collateral events"))
    }
    ...
    pub async fn get_points(
        ...
        .map_err(|e| OrderbookError::database(format!("Error fetching points: {}", e)))
    }
}
