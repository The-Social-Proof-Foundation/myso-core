...
impl Limits {
    ...
    pub(crate) fn package_resolver(&self) -> myso_package_resolver::Limits {
    ...
    pub(crate) fn display(&self) -> myso_display::v2::Limits {
        myso_display::v2::Limits {
...
impl Default for Limits {
    fn default() -> Self {
        ...
        let display_limits = myso_display::v2::Limits::default();
