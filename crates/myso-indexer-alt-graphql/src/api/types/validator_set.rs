...
impl ValidatorSetContents {
    ...
    fn deserialize(
        ...
        type ReportRecords = BTreeMap<NativeMySoAddress, Vec<NativeMySoAddress>>;
        type AtRiskValidators = BTreeMap<NativeMySoAddress, u64>;
        ...
        impl AV::Visitor<'_, '_> for AddressVisitor {
            type Value = Option<NativeMySoAddress>;
            type Error = Error;
