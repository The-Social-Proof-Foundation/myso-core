...
use myso_package_resolver::CleverError;
use myso_package_resolver::ErrorConstants;
use myso_types::execution_status::ExecutionFailureStatus;
use myso_types::execution_status::ExecutionStatus as NativeExecutionStatus;
...
impl ExecutionError {
    ...
    ///
    /// Since protocol version 48, the MySo protocol layer automatically resolves module ID, which makes
...
async fn resolve_module_id_for_move_abort(
    ...
    use myso_types::execution_status::MoveLocationOpt;
        ...
        .await
    {
        ...
        Err(myso_package_resolver::error::Error::LinkageNotFound(_)) => {
