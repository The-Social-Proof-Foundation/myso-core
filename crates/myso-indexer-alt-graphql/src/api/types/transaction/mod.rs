...
use myso_indexer_alt_reader::kv_loader::TransactionContents as NativeTransactionContents;
...
impl TransactionContents {
    ...
    async fn sender(&self) -> Option<Result<Address, RpcError>> {
        async {
            ...
            Ok((sender != NativeMySoAddress::ZERO)
...
async fn tx_affected_address(
    ...
    mut query: Query<'_>,
    page: &Page<CTransaction>,
    affected_address: MySoAddress,
    sent_address: Option<MySoAddress>,
