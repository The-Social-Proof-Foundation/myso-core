...
use myso_types::base_types::MySoAddress as NativeAddress;
use myso_types::coin::COIN_METADATA_STRUCT_NAME;
use myso_types::coin::COIN_MODULE_NAME;
use myso_types::coin::CoinMetadata as NativeMetadata;
use myso_types::coin::RegulatedCoinMetadata;
use myso_types::coin::TreasuryCap;
use myso_types::coin_registry::Currency as NativeCurrency;
use myso_types::coin_registry::RegulatedState as NativeRegulated;
use myso_types::coin_registry::SupplyState as NativeSupply;
use myso_types::gas_coin::GAS;
use myso_types::gas_coin::TOTAL_SUPPLY_MIST;
use myso_types::object::Owner as NativeOwner;
...
impl CoinMetadata {
    ...
    pub(crate) async fn by_coin_type(
        ...
        let currency_id: MySoAddress = NativeCurrency::derive_object_id(coin_type.clone())
