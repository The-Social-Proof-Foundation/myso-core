...
use serde::Serialize;
use myso_indexer_alt_reader::packages::CheckpointBoundedOriginalPackageKey;
use myso_indexer_alt_reader::packages::PackageOriginalIdKey;
use myso_indexer_alt_reader::packages::VersionedOriginalPackageKey;
use myso_indexer_alt_reader::pg_reader::PgReader;
use myso_indexer_alt_schema::packages::StoredPackage;
use myso_indexer_alt_schema::schema::kv_packages;
use myso_package_resolver::Package as ParsedMovePackage;
use myso_pg_db::sql;
use myso_sql_macro::query;
use myso_types::base_types::ObjectID;
use myso_types::base_types::MySoAddress as NativeMySoAddress;
use myso_types::move_package::MovePackage as NativeMovePackage;
...
impl MovePackage {
    ...
    pub(crate) fn address_impl(&self) -> NativeMySoAddress {
        self.super_.super_.address
    }
