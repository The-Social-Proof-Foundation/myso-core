...
use myso_types::transaction::FundsWithdrawalArg as NativeFundsWithdrawalArg;
use myso_types::transaction::Reservation as NativeReservation;
use myso_types::transaction::WithdrawFrom as NativeWithdrawFrom;
use myso_types::transaction::WithdrawalTypeArg as NativeWithdrawalTypeArg;
use myso_types::type_input::StructInput;
