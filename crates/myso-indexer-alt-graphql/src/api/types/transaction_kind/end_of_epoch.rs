...
use myso_types::digests::ChainIdentifier as NativeChainIdentifier;
use myso_types::transaction::AuthenticatorStateExpire as NativeAuthenticatorStateExpire;
use myso_types::transaction::EndOfEpochTransactionKind as NativeEndOfEpochTransactionKind;
