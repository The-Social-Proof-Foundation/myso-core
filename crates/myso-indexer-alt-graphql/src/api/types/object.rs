...
use myso_indexer_alt_reader::consistent_reader;
use myso_indexer_alt_reader::consistent_reader::ConsistentReader;
use myso_indexer_alt_reader::kv_loader::KvLoader;
use myso_indexer_alt_reader::object_versions::CheckpointBoundedObjectVersionKey;
use myso_indexer_alt_reader::object_versions::VersionBoundedObjectVersionKey;
use myso_indexer_alt_reader::object_versions::VersionedObjectVersionKey;
use myso_indexer_alt_reader::pg_reader::PgReader;
use myso_indexer_alt_schema::objects::StoredObjVersion;
...
use myso_types::object::Object as NativeObject;
use myso_types::transaction::GenesisObject;
use tokio::join;
...
#[graphql(
    ...
    field(
        ...
        desc = "The MYSO returned to the sponsor or sender of the transaction that modifies or deletes this object."
    ),
    field(
...
impl Object {
    ...
    /// The Object's ID.
    pub(crate) async fn address(&self, ctx: &Context<'_>) -> Result<MySoAddress, RpcError> {
...
impl Object {
    ...
    pub(crate) fn with_address(scope: Scope, address: NativeMySoAddress) -> Self {
    ...
    fn from_stored_version(
        ...
        let address = Address::with_address(
            scope,
            NativeMySoAddress::from_bytes(stored.object_id)
                .context("Failed to deserialize MySoAddress")?,
        );
