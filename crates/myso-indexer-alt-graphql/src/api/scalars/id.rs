...
pub(crate) enum Id {
    ...
    Checkpoint(u64),
    DynamicFieldByAddress(NativeMySoAddress),
    DynamicFieldByRef(NativeMySoAddress, SequenceNumber, ObjectDigest),
    Epoch(u64),
    MoveObjectByAddress(NativeMySoAddress),
    MoveObjectByRef(NativeMySoAddress, SequenceNumber, ObjectDigest),
    MovePackage(NativeMySoAddress),
