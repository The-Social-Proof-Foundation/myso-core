...
use myso::{bls12381::{Self, G1, G2, GT}, group_ops::Element};

const DST_KDF: vector<u8> = b"MYSO-MYDATA-IBE-BLS12381-H2-00";
const DST_ID: vector<u8> = b"MYSO-MYDATA-IBE-BLS12381-00";
...
#[test]
fun test_kdf() {
    use myso::bls12381::{scalar_from_u64, g2_generator, gt_generator, g2_mul, gt_mul};
