#[test_only]
module myso_groups::display_tests;
...
#[test, expected_failure(abort_code = myso_groups::display::ETypeNotFromModule)]
fun setup_display_wrong_publisher_fails() {
    ...
    display::setup_display<myso_groups::permissioned_group::PermissionsAdmin>(
        &pg_publisher,
        &publisher,
