...
#[test_only]
module myso_groups::self_service_actor;
...
/// - Payment verification (e.g., require Coin<MYSO> with minimum amount)
...
use myso_groups::permissioned_group::ExtensionPermissionsAdmin;
use myso_groups::permissioned_group::PermissionsAdmin;
...
use myso_groups::permissioned_group::ObjectAdmin;
