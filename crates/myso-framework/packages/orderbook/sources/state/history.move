...
/// burns.
module orderbook::history;

use orderbook::{balances::{Self, Balances}, constants, math, trade_params::TradeParams};
use myso::{event, table::{Self, Table}};
...
public(package) fun calculate_rebate_amount(
    ...
    let maker_burn = max_rebates.myso() - rebates.myso();
