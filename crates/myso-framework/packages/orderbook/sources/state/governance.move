...
module orderbook::governance;

use orderbook::{constants, math, trade_params::{Self, TradeParams}};
use myso::{event, vec_map::{Self, VecMap}};
...
const VOTING_POWER_THRESHOLD: u64 = 100_000_000_000; // 100k myso
...
fun stake_to_voting_power(stake: u64): u64 {
    ...
    if (stake > VOTING_POWER_THRESHOLD) {
        voting_power =
            voting_power + math::sqrt(stake, constants::myso_unit()) -
            math::sqrt(VOTING_POWER_THRESHOLD, constants::myso_unit());
    };
