...
module myso::token_test_utils;

use myso::coin::{Self, TreasuryCap};
use myso::token::{Self, Token, TokenPolicy, TokenPolicyCap};
...
public fun return_treasury_cap(treasury_cap: TreasuryCap<TEST>) {
    myso::transfer::public_share_object(treasury_cap)
}
