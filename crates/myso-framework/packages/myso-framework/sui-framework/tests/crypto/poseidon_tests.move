...
#[test_only]
module myso::poseidon_tests;

use std::u64::min;
use myso::poseidon::poseidon_bn254;
...
#[test]
#[expected_failure(abort_code = myso::poseidon::ENonCanonicalInput)]
...
#[test]
#[expected_failure(abort_code = myso::poseidon::EEmptyInput)]
...
#[test]
#[expected_failure(abort_code = myso::poseidon::ETooManyInputs)]
