...
module myso::kiosk_borrow_tests;

use myso::kiosk_test_utils::{Self as utils, Asset};
...
#[test]
#[expected_failure(abort_code = myso::kiosk::ENotOwner)]
...
#[test]
#[expected_failure(abort_code = myso::kiosk::EItemIsListed)]
...
#[test]
#[expected_failure(abort_code = myso::kiosk::EWrongKiosk)]
...
#[test]
#[expected_failure(abort_code = myso::kiosk::EItemMismatch)]
