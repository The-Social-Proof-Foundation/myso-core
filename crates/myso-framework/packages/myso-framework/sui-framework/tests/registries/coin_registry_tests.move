...
#[test_only]
module myso::coin_registry_tests;

use std::string::String;
use std::unit_test::{assert_eq, destroy};
use myso::coin::{Self, DenyCapV2, TreasuryCap, CoinMetadata};
use myso::coin_registry::{Self, Currency, CurrencyInitializer, CoinRegistry};
...
fun otw_currency_promotion() {
    ...
    let currency = test_scenario::most_recent_receiving_ticket<Currency<COIN_REGISTRY_TESTS>>(
        &object::myso_coin_registry_address().to_id(),
    );
