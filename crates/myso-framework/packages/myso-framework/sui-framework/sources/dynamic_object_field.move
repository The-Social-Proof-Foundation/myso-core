...
/// Similar to `myso::dynamic_field`, this module allows for the access of dynamic fields. But
/// unlike, `myso::dynamic_field` the values bound to these dynamic fields _must_ be objects
...
module myso::dynamic_object_field;
