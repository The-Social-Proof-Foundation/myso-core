...
#[test_only]
module myso::witness_policy_tests {
    use myso::transfer_policy as policy;
    use myso::transfer_policy_tests::{Self as test, Asset};
    use myso::witness_policy;
    ...
    #[test]
    #[expected_failure(abort_code = myso::witness_policy::ERuleNotFound)]
