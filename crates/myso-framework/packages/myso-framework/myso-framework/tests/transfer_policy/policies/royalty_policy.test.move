...
#[test_only]
module myso::royalty_policy_tests {
    use myso::coin;
    use myso::royalty_policy;
    use myso::myso::MYSO;
    use myso::transfer_policy as policy;
    use myso::transfer_policy_tests as test;
    ...
    fun test_default_flow() {
        ...
        let mut payment = coin::mint_for_testing<MYSO>(2000, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = myso::royalty_policy::EIncorrectArgument)]
    ...
    #[test]
    #[expected_failure(abort_code = myso::royalty_policy::EInsufficientAmount)]
    fun test_insufficient_amount() {
        ...
        let mut request = policy::new_request(test::fresh_id(ctx), 100_000, test::fresh_id(ctx));
        let mut payment = coin::mint_for_testing<MYSO>(999, ctx);
