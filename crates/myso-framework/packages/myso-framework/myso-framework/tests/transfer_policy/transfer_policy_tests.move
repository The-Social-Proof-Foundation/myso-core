...
#[test_only]
module myso::malicious_policy {
    use myso::transfer_policy::{Self as policy, TransferRequest};
...
#[test_only]
module myso::transfer_policy_tests {
    use myso::coin;
    use myso::dummy_policy;
    use myso::malicious_policy;
    use myso::package;
    use myso::transfer_policy::{Self as policy, TransferPolicy, TransferPolicyCap};
    ...
    #[test]
    #[expected_failure(abort_code = myso::transfer_policy::EPolicyNotSatisfied)]
    ...
    #[test]
    #[expected_failure(abort_code = myso::transfer_policy::ERuleAlreadySet)]
    ...
    #[test]
    #[expected_failure(abort_code = myso::transfer_policy::EIllegalRule)]
