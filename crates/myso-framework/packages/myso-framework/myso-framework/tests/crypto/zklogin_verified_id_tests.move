...
#[test_only]
module myso::zklogin_verified_id_tests;

use myso::test_scenario;
use myso::zklogin_verified_id::{check_zklogin_id, verify_zklogin_id};

#[test]
#[expected_failure(abort_code = myso::zklogin_verified_id::EFunctionDisabled)]
