...
#[test_only]
module myso::config_tests;

use std::unit_test::assert_eq;
use myso::config::{Self, Config};
...
fun config_create<WriteCap>(cap: &mut WriteCap, ctx: &mut TxContext) {
    myso::config::share(myso::config::new(cap, ctx))
}
...
#[test, expected_failure(abort_code = myso::config::EAlreadySetForEpoch)]
...
#[test, expected_failure(abort_code = myso::config::ENotSetForEpoch)]
...
#[test, expected_failure(abort_code = myso::dynamic_field::EFieldTypeMismatch)]
