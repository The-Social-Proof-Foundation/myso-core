...
#[test_only]
module myso::test_scenario_tests;
...
fun create_system_objects() {
    ...
    let clock = scenario.take_shared<myso::clock::Clock>();
    test_scenario::return_shared(clock);

    let random = scenario.take_shared<myso::random::Random>();
    test_scenario::return_shared(random);

    let deny_list = scenario.take_shared<myso::deny_list::DenyList>();
