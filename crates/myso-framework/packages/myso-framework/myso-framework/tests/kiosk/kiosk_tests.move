...
module myso::kiosk_tests;

use myso::coin;
use myso::kiosk_test_utils::{Self as test, Asset};
use myso::myso::MYSO;
...
#[test]
#[expected_failure(abort_code = myso::kiosk::EItemLocked)]
...
fun test_purchase() {
    ...
    let payment = coin::mint_for_testing<MYSO>(AMT, ctx);
...
#[test]
#[expected_failure(abort_code = myso::kiosk::ENotListed)]
...
#[test]
#[expected_failure(abort_code = myso::kiosk::EListedExclusively)]
...
#[allow(unused_field)]
public struct WrongAsset has key, store { id: myso::object::UID }

#[test]
#[expected_failure(abort_code = myso::kiosk::EItemNotFound)]
...
#[test]
#[expected_failure(abort_code = myso::kiosk::EIncorrectAmount)]
fun test_purchase_wrong_amount() {
    ...
    kiosk.place_and_list(&owner_cap, asset, AMT);
    let payment = coin::mint_for_testing<MYSO>(AMT + 1, ctx);
...
#[test]
#[expected_failure(abort_code = myso::kiosk::EAlreadyListed)]
...
#[test]
#[expected_failure(abort_code = myso::kiosk::ENotEmpty)]
...
#[test]
#[expected_failure(abort_code = myso::kiosk::ENotEnough)]
...
fun test_uid_access() {
    ...
    let uid = kiosk.uid();
    assert!(myso::object::uid_to_inner(uid) == myso::object::id(&kiosk));

    test::return_kiosk(kiosk, owner_cap, ctx);
}

#[test]
#[expected_failure(abort_code = myso::kiosk::EUidAccessNotAllowed)]
