...
#[test_only]
module myso::self_service_actor;
...
use myso::permissioned_group::ExtensionPermissionsAdmin;
use myso::permissioned_group::PermissionsAdmin;
...
use myso::permissioned_group::ObjectAdmin;
