#[test_only]
module myso::permissioned_group_display_tests;

use myso::permissioned_group_display::{Self, PermissionedGroupPublisher};
use myso::permissioned_group::PermissionedGroup;
use myso::display::Display;
use myso::package;
...
fun setup_display_creates_display_object() {
    ...
    ts.next_tx(ALICE);
    permissioned_group_display::init_for_testing(ts.ctx());
    ...
    let publisher = ts.take_from_sender<myso::package::Publisher>();

    permissioned_group_display::setup_display<DISPLAY_TESTS>(
        &pg_publisher,
        &publisher,
...
#[test, expected_failure(abort_code = myso::permissioned_group_display::ETypeNotFromModule)]
fun setup_display_wrong_publisher_fails() {
    ...
    permissioned_group_display::setup_display<myso::permissioned_group::PermissionsAdmin>(
        &pg_publisher,
        &publisher,
