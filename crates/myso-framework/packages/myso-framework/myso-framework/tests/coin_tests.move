...
#[test]
fun deny_list_v2() {
    use myso::coin::{deny_list_v2_add as add, deny_list_v2_remove as remove};
    let mut scenario = test_scenario::begin(@0);
    deny_list::create_for_testing(scenario.ctx());
    scenario.next_tx(TEST_ADDR);
...
#[test, expected_failure(abort_code = myso::coin::EGlobalPauseNotAllowed)]
