...
/// This module provides handy functionality for wallets and `myso::Coin` management.
module myso::pay;
...
/// Aborts with `myso::balance::ENotEnough` if `amount` is greater than the balance in `c`
