...
#[test_only]
module myso_system::validator_tests;
...
fun validator_owner_flow() {
    ...
    assert_eq!(validator.myso_address(), @2);
...
fun pending_validator_flow() {
    ...
    runner.owned_tx!<StakedMySo>(|staked_myso| {
        let withdrawn_balance = validator
            .request_withdraw_stake(staked_myso, runner.ctx())
            .destroy_for_testing();
...
#[test, expected_failure(abort_code = myso_system::validator::EMetadataInvalidPubkey)]
...
#[test, expected_failure(abort_code = myso_system::validator::EMetadataInvalidNetPubkey)]
...
#[test, expected_failure(abort_code = myso_system::validator::EMetadataInvalidWorkerPubkey)]
...
#[test, expected_failure(abort_code = myso_system::validator::EMetadataInvalidNetAddr)]
...
#[test, expected_failure(abort_code = myso_system::validator::EMetadataInvalidP2pAddr)]
...
#[test, expected_failure(abort_code = myso_system::validator::EMetadataInvalidPrimaryAddr)]
...
#[test, expected_failure(abort_code = myso_system::validator::EMetadataInvalidWorkerAddr)]
...
#[test, expected_failure(abort_code = myso_system::validator::EInvalidProofOfPossession)]
...
#[
    test,
    expected_failure(
        abort_code = myso_system::validator::EValidatorMetadataExceedingLengthLimit,
    ),
]
