...
module myso_system::storage_fund;
...
public struct StorageFund has store {
    total_object_storage_rebates: Balance<MYSO>,
    non_refundable_balance: Balance<MYSO>,
}

/// Called by `myso_system` at genesis time.
public(package) fun new(initial_fund: Balance<MYSO>): StorageFund {
    StorageFund {
...
/// Called by `myso_system` at epoch change times to process the inflows and outflows of storage fund.
