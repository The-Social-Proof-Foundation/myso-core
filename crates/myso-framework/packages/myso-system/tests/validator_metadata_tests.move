...
#[test_only]
module myso_system::validator_metadata_tests;

use myso::test_scenario::{Self, Scenario};
use myso::url;
use myso_system::myso_system::MySoSystemState;
use myso_system::test_runner::{Self, TestRunner};
...
fun active_validator_update_metadata() {
    ...
    let validator = validator_builder::preset()
        .myso_address(new_validator_addr)
...
// Note: `pop` MUST be a valid signature using myso_address and protocol_pubkey_bytes.
