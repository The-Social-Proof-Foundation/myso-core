...
<a name="myso_rangeproofs_ENotSupported"></a>



<pre><code><b>const</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_ENotSupported">ENotSupported</a>: u64 = 0;
</code></pre>



<a name="myso_rangeproofs_EInvalidProof"></a>



<pre><code><b>const</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_EInvalidProof">EInvalidProof</a>: u64 = 1;
</code></pre>



<a name="myso_rangeproofs_EInvalidRange"></a>



<pre><code><b>const</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_EInvalidRange">EInvalidRange</a>: u64 = 2;
</code></pre>



<a name="myso_rangeproofs_EInvalidBatchSize"></a>



<pre><code><b>const</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_EInvalidBatchSize">EInvalidBatchSize</a>: u64 = 3;
</code></pre>



<a name="myso_rangeproofs_EUnsupportedVersion"></a>



<pre><code><b>const</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_EUnsupportedVersion">EUnsupportedVersion</a>: u64 = 4;
</code></pre>



<a name="myso_rangeproofs_EInvalidDst"></a>



<pre><code><b>const</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_EInvalidDst">EInvalidDst</a>: u64 = 5;
</code></pre>



<a name="myso_rangeproofs_MAX_DST_LENGTH"></a>



<pre><code><b>const</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_MAX_DST_LENGTH">MAX_DST_LENGTH</a>: u64 = 64;
</code></pre>



<a name="myso_rangeproofs_verify_bulletproofs_with_dst_ristretto255"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_verify_bulletproofs_with_dst_ristretto255">verify_bulletproofs_with_dst_ristretto255</a>(
    proof: &vector&lt;u8&gt;,
    bits: u8,
    commitments: &vector&lt;Element&lt;<a href="../myso/ristretto255.md#myso_ristretto255_G">ristretto255::G</a>&gt;&gt;,
    dst: &vector&lt;u8&gt;,
    version: u8,
): bool {
    ...
    match (version) {
        ...
        _ =&gt; <b>abort</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_EUnsupportedVersion">EUnsupportedVersion</a>,
    }
}
</code></pre>
...
<a name="myso_rangeproofs_verify_bulletproofs_ristretto255"></a>

## Function `verify_bulletproofs_ristretto255`

Disabled. This entry point always aborts; use <code><a href="../myso/rangeproofs.md#myso_rangeproofs_verify_bulletproofs_with_dst_ristretto255">verify_bulletproofs_with_dst_ristretto255</a></code>
instead.


<pre><code><b>public</b> <b>fun</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_verify_bulletproofs_ristretto255">verify_bulletproofs_ristretto255</a>(_proof: &vector&lt;u8&gt;, _bits: u8, _commitments: &vector&lt;<a href="../myso/group_ops.md#myso_group_ops_Element">myso::group_ops::Element</a>&lt;<a href="../myso/ristretto255.md#myso_ristretto255_G">myso::ristretto255::G</a>&gt;&gt;, _version: u8): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_verify_bulletproofs_ristretto255">verify_bulletproofs_ristretto255</a>(
    _proof: &vector&lt;u8&gt;,
    _bits: u8,
    _commitments: &vector&lt;Element&lt;<a href="../myso/ristretto255.md#myso_ristretto255_G">ristretto255::G</a>&gt;&gt;,
    _version: u8,
): bool {
    <b>abort</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_ENotSupported">ENotSupported</a>
}
</code></pre>
...
<a name="myso_rangeproofs_verify_bulletproofs_with_dst_ristretto255_internal"></a>

## Function `verify_bulletproofs_with_dst_ristretto255_internal`



<pre><code><b>fun</b> <a href="../myso/rangeproofs.md#myso_rangeproofs_verify_bulletproofs_with_dst_ristretto255_internal">verify_bulletproofs_with_dst_ristretto255_internal</a>(proof: &vector&lt;u8&gt;, bits: u8, commitments: &vector&lt;vector&lt;u8&gt;&gt;, dst: &vector&lt;u8&gt;): bool
</code></pre>
