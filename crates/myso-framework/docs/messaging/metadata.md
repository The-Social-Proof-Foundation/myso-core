---
title: Module `messaging::metadata`
---
...
-  [Function `get_data_value`](#messaging_metadata_get_data_value)
...
<dl>
<dt>
<code><a href="../messaging/metadata.md#messaging_metadata_name">name</a>: <a href="../std/string.md#std_string_String">std::string::String</a></code>
</dt>
<dd>
</dd>
<dt>
<code><a href="../messaging/metadata.md#messaging_metadata_uuid">uuid</a>: <a href="../std/string.md#std_string_String">std::string::String</a></code>
</dt>
<dd>
</dd>
<dt>
...
<dt>
<code><a href="../messaging/metadata.md#messaging_metadata_data">data</a>: <a href="../myso/vec_map.md#myso_vec_map_VecMap">myso::vec_map::VecMap</a>&lt;<a href="../std/string.md#std_string_String">std::string::String</a>, <a href="../std/string.md#std_string_String">std::string::String</a>&gt;</code>
</dt>
<dd>
</dd>
</dl>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../messaging/metadata.md#messaging_metadata_new">new</a>(<a href="../messaging/metadata.md#messaging_metadata_name">name</a>: <a href="../std/string.md#std_string_String">std::string::String</a>, <a href="../messaging/metadata.md#messaging_metadata_uuid">uuid</a>: <a href="../std/string.md#std_string_String">std::string::String</a>, <a href="../messaging/metadata.md#messaging_metadata_creator">creator</a>: <b>address</b>): <a href="../messaging/metadata.md#messaging_metadata_Metadata">messaging::metadata::Metadata</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../messaging/metadata.md#messaging_metadata_name">name</a>(self: &<a href="../messaging/metadata.md#messaging_metadata_Metadata">messaging::metadata::Metadata</a>): &<a href="../std/string.md#std_string_String">std::string::String</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../messaging/metadata.md#messaging_metadata_uuid">uuid</a>(self: &<a href="../messaging/metadata.md#messaging_metadata_Metadata">messaging::metadata::Metadata</a>): &<a href="../std/string.md#std_string_String">std::string::String</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../messaging/metadata.md#messaging_metadata_data">data</a>(self: &<a href="../messaging/metadata.md#messaging_metadata_Metadata">messaging::metadata::Metadata</a>): &<a href="../myso/vec_map.md#myso_vec_map_VecMap">myso::vec_map::VecMap</a>&lt;<a href="../std/string.md#std_string_String">std::string::String</a>, <a href="../std/string.md#std_string_String">std::string::String</a>&gt;
</code></pre>
...
<a name="messaging_metadata_get_data_value"></a>

## Function `get_data_value`

Returns the value for <code><a href="../messaging/metadata.md#messaging_metadata_key">key</a></code> when present in the data map.


<pre><code><b>public</b>(package) <b>fun</b> <a href="../messaging/metadata.md#messaging_metadata_get_data_value">get_data_value</a>(self: &<a href="../messaging/metadata.md#messaging_metadata_Metadata">messaging::metadata::Metadata</a>, <a href="../messaging/metadata.md#messaging_metadata_key">key</a>: &<a href="../std/string.md#std_string_String">std::string::String</a>): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<a href="../std/string.md#std_string_String">std::string::String</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../messaging/metadata.md#messaging_metadata_get_data_value">get_data_value</a>(self: &<a href="../messaging/metadata.md#messaging_metadata_Metadata">Metadata</a>, <a href="../messaging/metadata.md#messaging_metadata_key">key</a>: &String): Option&lt;String&gt; {
    <b>if</b> (self.<a href="../messaging/metadata.md#messaging_metadata_data">data</a>.contains(<a href="../messaging/metadata.md#messaging_metadata_key">key</a>)) {
        option::some(*self.<a href="../messaging/metadata.md#messaging_metadata_data">data</a>.get(<a href="../messaging/metadata.md#messaging_metadata_key">key</a>))
    } <b>else</b> {
        option::none()
    }
}
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../messaging/metadata.md#messaging_metadata_insert_data">insert_data</a>(self: &<b>mut</b> <a href="../messaging/metadata.md#messaging_metadata_Metadata">messaging::metadata::Metadata</a>, <a href="../messaging/metadata.md#messaging_metadata_key">key</a>: <a href="../std/string.md#std_string_String">std::string::String</a>, value: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../messaging/metadata.md#messaging_metadata_remove_data">remove_data</a>(self: &<b>mut</b> <a href="../messaging/metadata.md#messaging_metadata_Metadata">messaging::metadata::Metadata</a>, <a href="../messaging/metadata.md#messaging_metadata_key">key</a>: &<a href="../std/string.md#std_string_String">std::string::String</a>): (<a href="../std/string.md#std_string_String">std::string::String</a>, <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
