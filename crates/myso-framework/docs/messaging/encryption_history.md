---
title: Module `messaging::encryption_history`
---
...
<dt>
<code><a href="../messaging/encryption_history.md#messaging_encryption_history_group_id">group_id</a>: <a href="../myso/object.md#myso_object_ID">myso::object::ID</a></code>
</dt>
<dd>
 Associated <code>PermissionedGroup&lt;Messaging&gt;</code> ID.
</dd>
<dt>
<code><a href="../messaging/encryption_history.md#messaging_encryption_history_uuid">uuid</a>: <a href="../std/string.md#std_string_String">std::string::String</a></code>
</dt>
<dd>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../messaging/encryption_history.md#messaging_encryption_history_new">new</a>(namespace_uid: &<b>mut</b> <a href="../myso/object.md#myso_object_UID">myso::object::UID</a>, <a href="../messaging/encryption_history.md#messaging_encryption_history_uuid">uuid</a>: <a href="../std/string.md#std_string_String">std::string::String</a>, <a href="../messaging/encryption_history.md#messaging_encryption_history_group_id">group_id</a>: <a href="../myso/object.md#myso_object_ID">myso::object::ID</a>, initial_encrypted_dek: vector&lt;u8&gt;, ctx: &<b>mut</b> <a href="../myso/tx_context.md#myso_tx_context_TxContext">myso::tx_context::TxContext</a>): <a href="../messaging/encryption_history.md#messaging_encryption_history_EncryptionHistory">messaging::encryption_history::EncryptionHistory</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../messaging/encryption_history.md#messaging_encryption_history_group_id">group_id</a>(self: &<a href="../messaging/encryption_history.md#messaging_encryption_history_EncryptionHistory">messaging::encryption_history::EncryptionHistory</a>): <a href="../myso/object.md#myso_object_ID">myso::object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../messaging/encryption_history.md#messaging_encryption_history_uuid">uuid</a>(self: &<a href="../messaging/encryption_history.md#messaging_encryption_history_EncryptionHistory">messaging::encryption_history::EncryptionHistory</a>): <a href="../std/string.md#std_string_String">std::string::String</a>
</code></pre>
