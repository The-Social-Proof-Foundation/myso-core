...
/// Unique ID of a MySo Event, the ID is a combination of transaction digest and event seq number.
#[serde_as]
...
impl Event {
    ...
    pub fn is_system_epoch_info_event(&self) -> bool {
        self.type_.address == MYSO_SYSTEM_ADDRESS
            && self.type_.module.as_ident_str() == ident_str!("myso_system_state_inner")
