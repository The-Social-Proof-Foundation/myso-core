...
use super::myso_system_state_inner_v1::ValidatorV1;
use super::myso_system_state_summary::{MySoSystemStateSummary, MySoValidatorSummary};
use super::{AdvanceEpochParams, MySoSystemStateTrait};
...
/// Rust version of the Move myso_system::myso_system::MySoSystemStateInnerV2 type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct MySoSystemStateInnerV2 {
    pub epoch: u64,
...
impl MySoSystemStateTrait for MySoSystemStateInnerV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
