...
use crate::myso_system_state::myso_system_state_summary::{
...
pub struct SimTestMySoSystemStateInnerV1 {
    pub epoch: u64,
...
impl MySoSystemStateTrait for SimTestMySoSystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn into_myso_system_state_summary(self) -> MySoSystemStateSummary {
        MySoSystemStateSummary::default()
    }
}

#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestMySoSystemStateInnerShallowV2 {
...
impl MySoSystemStateTrait for SimTestMySoSystemStateInnerShallowV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
...
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestMySoSystemStateInnerDeepV2 {
    pub new_dummy_field: u64,
    pub epoch: u64,
    pub protocol_version: u64,
    pub system_state_version: u64,
...
impl MySoSystemStateTrait for SimTestMySoSystemStateInnerDeepV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
