...
/// Rust version of the Move myso::accumulator_metadata::AccumulatorObjectCountKey type.
...
pub fn get_accumulator_object_count(object_store: &dyn ObjectStore) -> MySoResult<Option<u64>> {
    DynamicFieldKey(
