...
pub enum ExecutionFailureStatus {
    ...
    InsufficientGas,
    #[error("Invalid Gas Object. Possibly not address-owned or possibly not a MYSO coin.")]
    InvalidGasObject,
    ...
    #[error(
        ...
        Please run the MySo Move Verifier for more information."
    )]
    ...
    #[error(
        "MySo Move Bytecode Verification Timeout. \
        Please run the MySo Move Verifier for more information."
    )]
