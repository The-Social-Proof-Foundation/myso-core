...
use crate::base_types::{EpochId, ObjectID, ObjectType, SequenceNumber, MySoAddress};
...
pub trait RpcIndexes: Send + Sync {
    ...
    fn get_balance(&self, owner: &MySoAddress, coin_type: &StructTag)
...
pub struct EpochInfo {
    ...
    pub system_state: Option<crate::myso_system_state::MySoSystemState>,
    // pub end_of_epoch_transaction: Option<TransactionDigest>,
    // pub epoch_commitments: Vec<myso_types::messages_checkpoint::CheckpointCommitment>,
}
