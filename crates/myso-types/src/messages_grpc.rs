...
pub struct ObjectInfoResponse {
    ...
    /// This should be only used for debugging purpose, such as from myso-tool. No prod clients should
    /// rely on it.
...
/// Soft Bundle request.  See [SIP-19](https://github.com/myso-foundation/sips/blob/main/sips/sip-19.md).
#[derive(Clone, Debug, Serialize, Deserialize)]
...
impl SubmitTxRequest {
    pub fn into_raw(&self) -> Result<RawSubmitTxRequest, MySoError> {
...
pub enum WaitForEffectsResponse {
    ...
    Rejected {
        ...
        error: Option<crate::error::MySoError>,
    },
...
impl TryFrom<RawExecutedData> for ExecutedData {
    ...
    fn try_from(value: RawExecutedData) -> Result<Self, Self::Error> {
        let effects = bcs::from_bytes(&value.effects).map_err(|err| {
            crate::error::MySoErrorKind::GrpcMessageDeserializeError {
...
impl TryFrom<RawSubmitTxResult> for SubmitTxResult {
    ...
    fn try_from(value: RawSubmitTxResult) -> Result<Self, Self::Error> {
        match value.inner {
            ...
            None => Err(crate::error::MySoErrorKind::GrpcMessageDeserializeError {
...
impl TryFrom<RawSubmitTxResponse> for SubmitTxResponse {
    ...
    fn try_from(value: RawSubmitTxResponse) -> Result<Self, Self::Error> {
        ...
        if value.results.len() != 1 {
            return Err(crate::error::MySoErrorKind::GrpcMessageDeserializeError {
        ...
        let results = value
            ...
            .collect::<Result<Vec<SubmitTxResult>, crate::error::MySoError>>()?;
...
fn try_from_raw_rejected_status(
    rejected: RawRejectedStatus,
) -> Result<Option<crate::error::MySoError>, crate::error::MySoError> {
...
fn try_from_response_rejected(
    error: Option<crate::error::MySoError>,
) -> Result<RawRejectedStatus, crate::error::MySoError> {
...
fn try_from_response_executed(
    ...
    details: Option<Box<ExecutedData>>,
    fast_path: bool,
) -> Result<RawExecutedStatus, crate::error::MySoError> {
...
impl TryFrom<RawWaitForEffectsRequest> for WaitForEffectsRequest {
    ...
    fn try_from(value: RawWaitForEffectsRequest) -> Result<Self, Self::Error> {
        ...
        let ping_type = value
            .ping_type
            .map(|p| {
                PingType::try_from(p).map_err(|e| MySoErrorKind::GrpcMessageDeserializeError {
...
mod tests {
    ...
    async fn test_submit_tx_request_into_raw() {
        ...
        );
        {
            ...
            let sender = crate::base_types::MySoAddress::random_for_testing_only();
            let recipient = crate::base_types::MySoAddress::random_for_testing_only();
