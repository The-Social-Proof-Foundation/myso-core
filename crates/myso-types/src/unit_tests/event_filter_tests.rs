...
use crate::base_types::{ObjectDigest, MySoAddress, TransactionDigest};
use crate::event::{Event, EventEnvelope};
use crate::filter::{EventFilter, Filter};
use crate::gas_coin::GasCoin;
use crate::object::OBJECT_START_VERSION;
use crate::{ObjectID, MOVE_STDLIB_ADDRESS, MYSO_FRAMEWORK_ADDRESS};
...
fn test_move_event_filter() {
    ...
    let move_event = Event {
        package_id: ObjectID::from(MYSO_FRAMEWORK_ADDRESS),
    ...
    let filters = vec![
        ...
        EventFilter::Package(ObjectID::from(MYSO_FRAMEWORK_ADDRESS)),
...
fn test_transfer_filter() {
    ...
    let recipient = Owner::AddressOwner(MySoAddress::random_for_testing_only());
