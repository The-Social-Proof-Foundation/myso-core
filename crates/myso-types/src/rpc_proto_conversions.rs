...
//! Module for conversions from myso-core types to rpc protos
            ...
            self.transactions = source
                ...
                .map(|t| {
                    ...
                    transaction.timestamp = submask
                        ...
                        .then(|| myso_rpc::proto::timestamp_ms_to_proto(timestamp_ms));
                    transaction
                })
                .collect();
        }
...
impl Merge<crate::messages_checkpoint::CheckpointSummary> for CheckpointSummary {
    fn merge(
        ...
        if mask.contains(Self::TIMESTAMP_FIELD) {
            self.timestamp = Some(myso_rpc::proto::timestamp_ms_to_proto(timestamp_ms));
        }
...
impl From<crate::myso_system_state::MySoSystemState> for SystemState {
    fn from(value: crate::myso_system_state::MySoSystemState) -> Self {
        match value {
            crate::myso_system_state::MySoSystemState::V1(v1) => v1.into(),
            crate::myso_system_state::MySoSystemState::V2(v2) => v2.into(),
...
impl From<crate::myso_system_state::myso_system_state_inner_v1::MySoSystemStateInnerV1>
    for SystemState
{
    fn from(
        crate::myso_system_state::myso_system_state_inner_v1::MySoSystemStateInnerV1 {
            epoch,
            protocol_version,
...
impl From<crate::myso_system_state::myso_system_state_inner_v2::MySoSystemStateInnerV2>
    for SystemState
{
    fn from(
        crate::myso_system_state::myso_system_state_inner_v2::MySoSystemStateInnerV2 {
            epoch,
            protocol_version,
            system_state_version,
            validators,
...
impl From<crate::myso_system_state::myso_system_state_inner_v1::StakeSubsidyV1> for StakeSubsidy {
    fn from(
...
impl From<crate::myso_system_state::myso_system_state_inner_v1::SystemParametersV1>
    for SystemParameters
{
    fn from(
        crate::myso_system_state::myso_system_state_inner_v1::SystemParametersV1 {
            epoch_duration_ms,
...
impl From<crate::myso_system_state::myso_system_state_inner_v2::SystemParametersV2>
    for SystemParameters
{
    fn from(
        crate::myso_system_state::myso_system_state_inner_v2::SystemParametersV2 {
            epoch_duration_ms,
            stake_subsidy_start_epoch,
            min_validator_count,
            max_validator_count,
...
impl From<crate::myso_system_state::myso_system_state_inner_v1::StorageFundV1> for StorageFund {
    fn from(
        crate::myso_system_state::myso_system_state_inner_v1::StorageFundV1 {
...
impl From<crate::myso_system_state::myso_system_state_inner_v1::ValidatorSetV1> for ValidatorSet {
    fn from(
        crate::myso_system_state::myso_system_state_inner_v1::ValidatorSetV1 {
            total_stake,
            active_validators,
...
impl From<crate::myso_system_state::myso_system_state_inner_v1::StakingPoolV1> for StakingPool {
    fn from(
        crate::myso_system_state::myso_system_state_inner_v1::StakingPoolV1 {
            id,
            activation_epoch,
            deactivation_epoch,
            myso_balance,
...
impl From<crate::myso_system_state::myso_system_state_inner_v1::ValidatorV1> for Validator {
    fn from(
        crate::myso_system_state::myso_system_state_inner_v1::ValidatorV1 {
            metadata:
                crate::myso_system_state::myso_system_state_inner_v1::ValidatorMetadataV1 {
                    myso_address,
        ...
        message.address = Some(myso_address.to_string());
...
impl TryFrom<&SystemState>
    for crate::myso_system_state::myso_system_state_summary::MySoSystemStateSummary
{
    type Error = TryFromProtoError;
...
impl TryFrom<&Validator>
    for crate::myso_system_state::myso_system_state_summary::MySoValidatorSummary
{
    type Error = TryFromProtoError;
    ...
    for crate::crypto::AuthorityQuorumSignInfo<T>
{
    ...
    fn try_from(value: &ValidatorAggregatedSignature) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            signers_map: crate::myso_serde::deserialize_myso_bitmap(value.bitmap())
...
impl From<&crate::zk_login_authenticator::ZkLoginAuthenticator> for ZkLoginAuthenticator {
    fn from(value: &crate::zk_login_authenticator::ZkLoginAuthenticator) -> Self {
        ...
        myso_sdk_types::ZkLoginAuthenticator::try_from(value.clone())
            .map(Into::into)
            .ok()
            .unwrap_or(message)
    }
...
impl From<&crate::crypto::ZkLoginPublicIdentifier> for ZkLoginPublicIdentifier {
    fn from(value: &crate::crypto::ZkLoginPublicIdentifier) -> Self {
        //TODO implement this without going through the sdk type
        myso_sdk_types::ZkLoginPublicIdentifier::try_from(value.to_owned())
            .map(|id| (&id).into())
            .ok()
            .unwrap_or_default()
    }
    ...
    fn from(value: crate::transaction::TransactionExpiration) -> Self {
        ...
        let kind = match value {
            ...
            E::ValidDuring {
                ...
                message.set_chain(myso_sdk_types::Digest::new(*chain.as_bytes()));
...
impl From<crate::messages_consensus::ConsensusCommitPrologue> for ConsensusCommitPrologue {
    fn from(value: crate::messages_consensus::ConsensusCommitPrologue) -> Self {
        ...
        message.commit_timestamp = Some(myso_rpc::proto::timestamp_ms_to_proto(
...
impl From<crate::transaction::ChangeEpoch> for ChangeEpoch {
    fn from(value: crate::transaction::ChangeEpoch) -> Self {
        ...
        message.epoch_start_timestamp = Some(myso_rpc::proto::timestamp_ms_to_proto(
...
impl From<&crate::coin_registry::Currency> for CoinMetadata {
    fn from(value: &crate::coin_registry::Currency) -> Self {
        ...
        metadata.id = Some(myso_sdk_types::Address::from(value.id.into_bytes()).to_string());
        ...
        match &value.metadata_cap_id {
            crate::coin_registry::MetadataCapState::Claimed(id) => {
                ...
                metadata.metadata_cap_id = Some(myso_sdk_types::Address::from(*id).to_string());
            }
            crate::coin_registry::MetadataCapState::Unclaimed => {
...
impl From<crate::coin::CoinMetadata> for CoinMetadata {
    fn from(value: crate::coin::CoinMetadata) -> Self {
        let mut metadata = CoinMetadata::default();
        metadata.id = Some(myso_sdk_types::Address::from(value.id.id.bytes).to_string());
        metadata.decimals = Some(value.decimals.into());
...
impl From<crate::coin::TreasuryCap> for CoinTreasury {
    fn from(value: crate::coin::TreasuryCap) -> Self {
        ...
        treasury.id = Some(myso_sdk_types::Address::from(value.id.id.bytes).to_string());
    ...
    fn from(value: &crate::coin_registry::RegulatedState) -> Self {
        ...
        match value {
            crate::coin_registry::RegulatedState::Regulated {
                ...
                regulated.deny_cap_object = Some(myso_sdk_types::Address::from(*cap).to_string());
...
impl From<crate::coin::RegulatedCoinMetadata> for RegulatedCoinMetadata {
    fn from(value: crate::coin::RegulatedCoinMetadata) -> Self {
        ...
        message.id = Some(myso_sdk_types::Address::from(value.id.id.bytes).to_string());
        message.coin_metadata_object =
            Some(myso_sdk_types::Address::from(value.coin_metadata_object.bytes).to_string());
        message.deny_cap_object =
            Some(myso_sdk_types::Address::from(value.deny_cap_object.bytes).to_string());
