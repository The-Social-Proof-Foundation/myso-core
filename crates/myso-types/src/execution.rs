...
/// Used by myso-execution v1 and above, to capture the execution results from Move.
...
impl ExecutionResultsV2 {
    ...
    pub fn merge_results(&mut self, new_results: Self) {
        ...
        self.settlement_input_myso += new_results.settlement_input_myso;
        self.settlement_output_myso += new_results.settlement_output_myso;
    }
