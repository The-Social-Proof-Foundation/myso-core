...
//! Rust bindings for `myso::funds_accumulator`
...
/// Rust bindings for the Move struct `myso::funds_accumulator::Withdrawal`.
...
impl Withdrawal {
    pub fn new(owner: MySoAddress, limit: U256) -> Self {
        Self { owner, limit }
    }
