...
pub mod checked {
    ...
    #[enum_dispatch(MySoGasStatusAPI)]
    #[derive(Debug)]
    pub enum MySoGasStatus {
    ...
    impl MySoGasStatus {
        pub fn new(
            ...
            Ok(Self::V2(MySoGasStatusV2::new_with_budget(
                gas_budget,
                gas_price,
                reference_gas_price,
                config,
        ...
        pub fn new_unmetered() -> Self {
            Self::V2(MySoGasStatusV2::new_unmetered())
        }

        // This is the only public API on MySoGasStatus, all other gas related operations should
