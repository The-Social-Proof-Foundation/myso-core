...
//! Module for conversions between myso-core types and myso-sdk types
//!
...
use crate::crypto::MySoSignature as _;
...
impl From<crate::base_types::MySoAddress> for Address {
    fn from(value: crate::base_types::MySoAddress) -> Self {
        Self::new(value.to_inner())
    }
}

impl From<Address> for crate::base_types::MySoAddress {
    ...
    fn from(value: crate::effects::AccumulatorWriteV1) -> Self {
        let operation = match value.operation {
            crate::effects::AccumulatorOperation::Merge => {
                myso_sdk_types::AccumulatorOperation::Merge
            }
            crate::effects::AccumulatorOperation::Split => {
                myso_sdk_types::AccumulatorOperation::Split
            }
        };
        Self::new(
            ...
            crate::crypto::Signature::Secp256k1MySoSignature(secp256k1_myso_signature) => {
                Self::Secp256k1 {
                    signature: Secp256k1Signature::from_bytes(
                        secp256k1_myso_signature.signature_bytes(),
                    )?,
                    public_key: Secp256k1PublicKey::from_bytes(
                        secp256k1_myso_signature.public_key_bytes(),
                    )?,
                }
            }

            crate::crypto::Signature::Secp256r1MySoSignature(secp256r1_myso_signature) => {
                Self::Secp256r1 {
                    signature: Secp256r1Signature::from_bytes(
                        secp256r1_myso_signature.signature_bytes(),
                    )?,
                    public_key: Secp256r1PublicKey::from_bytes(
                        secp256r1_myso_signature.public_key_bytes(),
                    )?,
                }
            }
        }
