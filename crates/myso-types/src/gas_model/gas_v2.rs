...
mod checked {
    ...
    use crate::gas::{self, GasCostSummary, GasUsageReport, MySoGasStatusAPI};
    ...
    /// A list of constant costs of various operations in MySo.
    pub struct MySoCostTable {
    ...
    impl std::fmt::Debug for MySoCostTable {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            // TODO: dump the fields.
            write!(f, "MySoCostTable(...)")
        }
    }
    ...
    pub struct PerObjectStorage {
        ...
        /// storage_rebate is the storage rebate (in MySo) for in this object.
        /// This is computed at the end of execution while determining storage charges.
        /// The value is in MySo.
    ...
    impl MySoGasStatus {
        ...
        pub(crate) fn new_with_budget(
            ...
            let myso_cost_table = MySoCostTable::new(config, gas_price);
            ...
            Self::new(
                GasStatus::new(
                    myso_cost_table.execution_cost_table.clone(),
                    computation_budget,
                    gas_price,
        ...
        pub fn new_unmetered() -> MySoGasStatus {
            Self::new(
    ...
    impl MySoGasStatusAPI for MySoGasStatus {
