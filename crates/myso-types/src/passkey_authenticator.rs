...
use crate::crypto::Secp256r1MySoSignature;
...
impl TryFrom<RawPasskeyAuthenticator> for PasskeyAuthenticator {
    ...
    fn try_from(raw: RawPasskeyAuthenticator) -> Result<Self, Self::Error> {
        ...
        let pk = Secp256r1PublicKey::from_bytes(raw.user_signature.public_key_bytes()).map_err(
            |_| MySoErrorKind::InvalidSignature {
...
impl<'de> Deserialize<'de> for PasskeyAuthenticator {
        ...
        D: Deserializer<'de>,
    {
        ...
        serializable
            .try_into()
            .map_err(|e: MySoError| Error::custom(e.to_string()))
    }
}
...
impl Serialize for PasskeyAuthenticator {
    ...
    {
        let mut bytes = Vec::with_capacity(Secp256r1MySoSignature::LENGTH);
        ...
        let raw = RawPasskeyAuthenticator {
            ...
            user_signature: Signature::Secp256r1MySoSignature(
                Secp256r1MySoSignature::from_bytes(&bytes).unwrap(), // ok to unwrap since the bytes are constructed as valid above.
            ),
        };
...
impl PasskeyAuthenticator {
    ...
    pub fn get_pk(&self) -> MySoResult<PublicKey> {
    ...
    pub fn signature(&self) -> Signature {
        ...
        Signature::Secp256r1MySoSignature(Secp256r1MySoSignature::from_bytes(&bytes).unwrap())
    }
}
...
impl AuthenticatorTrait for PasskeyAuthenticator {
        ...
        T: Serialize,
    {
        ...
        if author != MySoAddress::from(&self.get_pk()?) {
            return Err(MySoErrorKind::InvalidSignature {
