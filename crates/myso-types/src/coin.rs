...
pub const RESOLVED_COIN_STRUCT: (&AccountAddress, &IdentStr, &IdentStr) =
    (&MYSO_FRAMEWORK_ADDRESS, COIN_MODULE_NAME, COIN_STRUCT_NAME);
...
// Rust version of the Move myso::coin::Coin type
...
impl Coin {
    ...
    pub fn is_coin(other: &StructTag) -> bool {
        other.address == MYSO_FRAMEWORK_ADDRESS
...
// Rust version of the Move myso::coin::TreasuryCap type
...
impl TreasuryCap {
    ...
    pub fn from_bcs_bytes(content: &[u8]) -> Result<Self, MySoError> {
...
// Rust version of the Move myso::coin::CoinMetadata type
#[derive(Debug, Serialize, Deserialize, Clone, JsonSchema, Eq, PartialEq)]
...
// Rust version of the Move myso::coin::RegulatedCoinMetadata type
