...
use crate::{
    ...
    crypto::DefaultHash,
    error::{ExecutionError, ExecutionErrorKind, MySoErrorKind, MySoResult},
    id::{ID, UID},
...
/// Rust representation of upgrade policy constants in `myso::package`.
#[repr(u8)]
...
/// Rust representation of `myso::package::UpgradeCap`.
...
/// Rust representation of `myso::package::UpgradeTicket`.
#[derive(Debug, Serialize, Deserialize)]
...
/// Rust representation of `myso::package::UpgradeReceipt`.
#[derive(Debug, Serialize, Deserialize)]
...
impl MovePackage {
    ...
    pub fn normalize<S: Hash + Eq + Clone + ToString, Pool: normalized::StringPool<String = S>>(
        ...
        binary_config: &BinaryConfig,
        include_code: bool,
    ) -> MySoResult<BTreeMap<String, normalized::Module<S>>> {
