...
use myso_types::myso_system_state::mock;
...
use myso_indexer_alt_e2e_tests::local_ingestion_client_args;
use myso_indexer_alt_e2e_tests::write_checkpoint;
...
async fn safe_mode_system_state_v1() {
    let myso_system_state = MySoSystemState::V1(MySoSystemStateInnerV1 {
        safe_mode: ENABLED,
        ...
        ..mock::myso_system_state_inner_v1()
    });
    ...
    let EpochSystemState {
        ...
        SAFE_MODE_QUERY,
        myso_system_state.clone(),
        AdvanceEpochConfig {
            output_objects: mock::system_state_output_objects(myso_system_state),
            ..Default::default()
        },
    )
    .await;
...
async fn safe_mode_system_state_v2() {
    let myso_system_state = MySoSystemState::V2(MySoSystemStateInnerV2 {
        safe_mode: ENABLED,
        safe_mode_computation_rewards: Balance::new(COMPUTATION_COST),
        safe_mode_storage_rewards: Balance::new(STORAGE_COST),
        safe_mode_storage_rebates: STORAGE_REBATE,
        safe_mode_non_refundable_storage_fee: NON_REFUNDABLE_STORAGE_FEE,
        ..mock::myso_system_state_inner_v2()
    });
...
async fn live_object_set_digest() {
    let myso_system_state = MySoSystemState::V2(mock::myso_system_state_inner_v2());
...
async fn test_graphql<T: DeserializeOwned>(
    query: &str,
    genesis_myso_system_state: MySoSystemState,
        ...
        OffchainClusterConfig {
            ...
            bootstrap_genesis: Some(BootstrapGenesis {
                ...
                stored_epoch_start: StoredEpochStart {
                    ...
                    system_state: bcs::to_bytes(&genesis_myso_system_state).unwrap(),
                },
            }),
            ..Default::default()
        },
