...
//# programmable --sender A --inputs object(1,0) 42
//> 0: myso::bag::remove<u64, u64>(Input(0), Input(1))
...
//> 1: myso::object_bag::add<u64, myso::coin::Coin<myso::myso::MYSO>>(Input(0), Input(1), Result(0))
...
//# programmable --sender A --inputs object(10,0) 43
//> 0: myso::object_bag::remove<u64, myso::coin::Coin<myso::myso::MYSO>>(Input(0), Input(1));
