...
//> 0: myso::bag::add<u64, u64>(Input(0), Input(1), Input(1))

//# programmable --sender A --inputs 2000
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: myso::transfer::public_share_object<myso::coin::Coin<myso::myso::MYSO>>(Result(0));

//# programmable --sender A --inputs 3000
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: myso::transfer::public_freeze_object<myso::coin::Coin<myso::myso::MYSO>>(Result(0));

//# programmable --sender A --inputs 4000 @A
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: myso::party::single_owner(Input(1));
//> 2: myso::transfer::public_party_transfer<myso::coin::Coin<myso::myso::MYSO>>(Result(0), Result(1));
