...
//> 1: myso::object::id_address<myso::coin::Coin<myso::myso::MYSO>>(Gas);
...
//> 1: myso::object::id_address<myso::coin::Coin<myso::myso::MYSO>>(NestedResult(0,0));
//> 2: TransferObjects([NestedResult(0,1)], Result(1));
//> 3: myso::object::id_address<myso::coin::Coin<myso::myso::MYSO>>(Gas);
...
{ # ... and for balance point-lookups
  object(address: "@{obj_0_0}", version: 2) {
    balance(coinType: "0x2::myso::MYSO") { totalBalance }
  }
}
...
{ # ... and balance multi-gets
  object(address: "@{obj_0_0}", version: 2) {
    multiGetBalances(keys: ["0x2::myso::MYSO"]) { totalBalance }
  }
}
...
fragment Owned on IAddressable {
  ...
  myso: balance(coinType: "0x2::myso::MYSO") { totalBalance }
