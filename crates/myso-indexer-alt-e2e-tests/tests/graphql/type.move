...
//# run-graphql
{ # Happy paths
  complex: type(type: "0x2::priority_queue::PriorityQueue<0x2::coin::Coin<0x2::myso::MYSO>>") { ...Type }
  coin: type(type: "0x2::coin::Coin<0x2::myso::MYSO>") { ...Type }
  token: type(type: "0x2::token::Token<0x2::myso::MYSO>") { ...Type }
  balance: type(type: "0x2::balance::Balance<0x2::myso::MYSO>") { ...Type }
  primitive: type(type: "u64") { ...Type }
  prim_vector: type(type: "vector<u64>") { ...Type }
  coin_vector: type(type: "vector<0x2::coin::Coin<0x2::myso::MYSO>>") { ...Type }
}
...
{ # Multi-get
  multiGetTypes(keys: [
    "0x2::priority_queue::PriorityQueue<0x2::coin::Coin<0x2::myso::MYSO>>",
    "0x2::coin::Coin<0x2::myso::MYSO>",
    "0x2::token::Token<0x2::myso::MYSO>",
    "0x2::balance::Balance<0x2::myso::MYSO>",
    "u64",
    "vector<u64>",
    "vector<0x2::coin::Coin<0x2::myso::MYSO>>",
...
{ # Unhappy path, type argument arity mismatch
  type(type: "0x2::coin::Coin<0x2::myso::MYSO, u64>") {
    abilities
  }
}
