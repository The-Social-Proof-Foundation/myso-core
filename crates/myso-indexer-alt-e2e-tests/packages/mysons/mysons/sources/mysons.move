...
/// A mock of the MySoNS Move package to use during testing.
///
/// It provides enough structure to query MySoNS's on-chain state, but it
/// doesn't maintain the same invariants.
module mysons::mysons;

use std::string::String;
use myso::table::{Self, Table};
use myso::vec_map::{Self, VecMap};

use mysons::domain::{Self, Domain};
