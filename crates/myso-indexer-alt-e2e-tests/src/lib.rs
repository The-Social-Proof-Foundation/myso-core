...
use myso_indexer_alt::setup_indexer;
use myso_indexer_alt_consistent_api::proto::rpc::consistent::v1alpha::AvailableRangeRequest;
use myso_indexer_alt_consistent_api::proto::rpc::consistent::v1alpha::consistent_service_client::ConsistentServiceClient;
use myso_indexer_alt_consistent_store::args::RpcArgs as ConsistentArgs;
use myso_indexer_alt_consistent_store::args::TlsArgs as ConsistentTlsArgs;
use myso_indexer_alt_consistent_store::config::ServiceConfig as ConsistentConfig;
use myso_indexer_alt_consistent_store::start_service as start_consistent_store;
...
use myso_indexer_alt_framework::postgres::schema::watermarks;
...
use myso_indexer_alt_graphql::start_rpc as start_graphql;
use myso_indexer_alt_jsonrpc::NodeArgs as JsonRpcNodeArgs;
use myso_indexer_alt_jsonrpc::RpcArgs as JsonRpcArgs;
use myso_indexer_alt_jsonrpc::config::RpcConfig as JsonRpcConfig;
use myso_indexer_alt_jsonrpc::start_rpc as start_jsonrpc;
...
use myso_indexer_alt_reader::fullnode_client::FullnodeArgs;
...
impl FullCluster {
    ...
    pub fn funded_account(
        &mut self,
        amount: u64,
    ) -> anyhow::Result<(MySoAddress, AccountKeyPair, ObjectRef)> {
