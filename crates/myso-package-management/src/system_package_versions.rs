...
pub const SYSTEM_GIT_REPO: &str = "https://github.com/the-social-proof-foundation/myso-core.git";
...
pub struct SystemPackage {
    /// The name of the package, e.g. "MySo"
    pub package_name: String,

    /// The path to the package in the myso monorepo
    /// e.g. "crates/myso-framework/packages/myso-framework"
