...
use myso_types::deny_list_v1::{PerTypeDenyList, get_coin_deny_list};
...
impl Genesis {
    ...
    pub fn validator_set_for_tooling(&self) -> Vec<MySoValidatorGenesis> {
        self.myso_system_object()
    ...
    pub fn committee_with_network(&self) -> CommitteeWithNetworkMetadata {
        self.myso_system_object().get_current_epoch_committee()
    }

    pub fn reference_gas_price(&self) -> u64 {
        self.myso_system_object().reference_gas_price()
    }
    ...
    pub fn myso_system_wrapper_object(&self) -> MySoSystemStateWrapper {
        get_myso_system_state_wrapper(&self.objects())
            .expect("MySo System State Wrapper object must always exist")
    }

    pub fn myso_system_object(&self) -> MySoSystemState {
        get_myso_system_state(&self.objects()).expect("MySo System State object must always exist")
    }
    ...
    pub fn clock(&self) -> Clock {
        let clock = self
            .objects()
            .iter()
            .find(|o| o.id() == myso_types::MYSO_CLOCK_OBJECT_ID)
...
impl UnsignedGenesis {
    ...
    pub fn has_randomness_state_object(&self) -> bool {
        self.objects()
            .get_object(&MYSO_RANDOMNESS_STATE_OBJECT_ID)
            .is_some()
    }

    pub fn has_bridge_object(&self) -> bool {
        self.objects().get_object(&MYSO_BRIDGE_OBJECT_ID).is_some()
    }
    ...
    pub fn to_genesis_chain_parameters(&self) -> GenesisChainParameters {
        GenesisChainParameters {
            ...
            validator_low_stake_threshold:
                myso_types::governance::VALIDATOR_LOW_STAKE_THRESHOLD_MIST,
            validator_very_low_stake_threshold:
                myso_types::governance::VALIDATOR_VERY_LOW_STAKE_THRESHOLD_MIST,
            validator_low_stake_grace_period:
                myso_types::governance::VALIDATOR_LOW_STAKE_GRACE_PERIOD,
        }
    }
}
...
impl TokenDistributionSchedule {
    ...
    pub fn check_all_stake_operations_are_for_valid_validators<
        I: IntoIterator<Item = MySoAddress>,
    >(
        &self,
        validators: I,
    ) {
        ...
        let mut validators: HashMap<MySoAddress, u64> =
    ...
    #[allow(deprecated)]
    pub fn new_for_validators_with_default_allocation<I: IntoIterator<Item = MySoAddress>>(
        validators: I,
    ) -> Self {
        let mut supply = TOTAL_SUPPLY_MIST;
        let default_allocation = myso_types::governance::VALIDATOR_LOW_STAKE_THRESHOLD_MIST;
    ...
    ///
    /// All entries in a token distribution schedule must add up to 10B MySo.
    ...
    pub fn to_csv<W: std::io::Write>(&self, writer: W) -> Result<()> {
        ...
        writer.serialize(TokenAllocation {
            recipient_address: MySoAddress::default(),
...
pub struct TokenAllocation {
    pub recipient_address: MySoAddress,
    pub amount_mist: u64,

    /// Indicates if this allocation should be staked at genesis and with which validator
    pub staked_with_validator: Option<MySoAddress>,
}
...
impl TokenDistributionScheduleBuilder {
    ...
    #[allow(deprecated)]
    pub fn default_allocation_for_validators<I: IntoIterator<Item = MySoAddress>>(
        &mut self,
        validators: I,
    ) {
        let default_allocation = myso_types::governance::VALIDATOR_LOW_STAKE_THRESHOLD_MIST;
