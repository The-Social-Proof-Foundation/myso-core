...
pub const MYSO_CONFIG_DIR: &str = "myso_config";
...
pub const MYSO_KEYSTORE_FILENAME: &str = "myso.keystore";
...
pub fn myso_config_dir() -> Result<PathBuf, anyhow::Error> {
    match std::env::var_os("MYSO_CONFIG_DIR") {
...
pub fn genesis_blob_exists(config_dir: Option<PathBuf>) -> bool {
    ...
    } else if let Some(config_env) = std::env::var_os("MYSO_CONFIG_DIR") {
